! function(t) {
  function e(g) {
    ...
    return t[g].call(s.exports, s, s.exports, e), s.l = !0, s.exports
  }
  var i = {};
  ...
  }, e.p = "/Tone.Editor/", e(e.s = 42)
}([function(t, e, i) {
  var g, s;
  g = [i(18), i(19), i(21)], void 0 !== (s = function(e, g, s) {
    Array.prototype.includes || Object.defineProperty(Array.prototype, "includes", {
      value: function(t, e) {
        ...
        var i = Object(this),
          g = i.length >>> 0;
        if (0 === g) return !1;
        for (var s = 0 | e, I = Math.max(s >= 0 ? s : g - Math.abs(s), 0); I < g;) {
          if (function(t, e) {
    ...
    }), Node.prototype.hasClass = function(t) {
      return this.classList ? this.classList.contains(t) : -1 < this.className.indexOf(t)
    ...
    I.extend = function(t, e) {
    ...
    }, I.remap = function(t, e, i, g, s) {
      return t < e && (t = e), t > i && (t = i), (t - e) * (s - g) / (i - e) + g
    }, I.remapLog = function(t, e, i, g, s) {
      var I = (s - g) / (i - e);
      if (t > i && (t = i), t > 0) var A = Math.exp(g + I * (t - e));
      else var A = 0;
      return A
    }, I.iterate = function(t, e) {
      ...
      return {
        width: t.innerWidth || i.clientWidth || g.clientWidth,
        height: t.innerHeight || i.clientHeight || g.clientHeight
      }
    }, I.downloadTextFile = function(t, e) {
      var i = document.createElement("a");
      i.setAttribute("href", "data:text/plain;charset=utf-8," + encodeURIComponent(e)), i.setAttribute("download", t), i.style.display = "none", document.body.appendChild(i), i.click(), document.body.removeChild(i)
    }, I.nodeFromString = function(t) {
      var e = document.createElement("div");
      return e.innerHTML = t, e.firstElementChild
    }, I.merge = i(20), I.classify = e, I.getMeta = g, I.isSignal = s, window.utils = I, t.exports = I
  }.apply(e, g)) && (t.exports = s)
}, function(t, e, i) {
  var g, s;
  g = [i(0), i(2), i(3)], void 0 !== (s = function(e, i, g, s) {
    function I() {
      i.components.forEach(function(t) {
        n.componentsByName[t.name] = {
          name: t.name,
          subComponentsByName: {},
          expanded: t.expandTriangle ? t.expanded : void 0
        }, t.expandTriangle && (n.componentsByName[t.name].expanded = t.expanded), t.subComponents.forEach(function(e) {
          n.componentsByName[t.name].subComponentsByName[e.name] = {
            name: e.name,
            expanded: e.expanded
          }
        })
      }), n.keyboard.octave = g.octave, n.keyboard.isActive = g.isActive, n.keyboard.isVisible = g.isVisible, null !== g.target && (n.keyboard.targetName = g.target.name), n.resizedWidth = i.resizedWidth, n.isCollapsed = i.isCollapsed, window.localStorage.setItem("ToneEditor", JSON.stringify(n))
    }

    function A() {
      var t = JSON.parse(window.localStorage.getItem("ToneEditor"));
      if (t) {
        if (n = t, e.iterate(n.componentsByName, function(t, g) {
            var s = i.componentsById[g.name];
            s && (null !== s.expandTriangle && (g.expanded ? s.expand() : s.collapse()), e.iterate(g.subComponentsByName, function(t, e) {
              var i = s.subComponentsByName[t];
              i && null !== i.expandTriangle && (e.expanded ? i.expand() : i.collapse())
            }))
          }), g.octave = t.keyboard.octave, null === t.keyboard.targetName);
        else if (void 0 !== i.componentsById[t.keyboard.targetName]) {
          var s = i.componentsById[t.keyboard.targetName];
          g.setTarget(s)
        }
        return t.keyboard.isActive ? g.activate() : g.deactivate(), t.keyboard.isVisible ? g.show() : g.hide(), i.resizedWidth = t.resizedWidth, t.isCollapsed ? i.collapse() : (i.element.classList.remove("transition-width"), i.expand(), i.resize(t.resizedWidth), i.element.classList.add("transition-width")), t
      }
    }
    var n = {
      isCollapsed: !1,
  ...
  g = [i(0)], void 0 !== (s = function(e) {
    Tone.Editor = function() {
      this._options = {
        ...
        columnWidth: 272,
        minPanelWidth: 290
      }, this.components = [], this.componentsById = {};
      var t = this;
      this._updateEditCount = function() {
        1 === this._editedParameters.length && t._copyAllButton.classList.add("visible")
      }, this.resizedWidth = 280, this.isCollapsed = !1, this._copyAllButton = null, this.element = document.querySelectorAll("div.tone-editor_container")[0];
      var e = document.createElement("div");
      e.innerHTML = i(29), this.element = e.firstElementChild, this.componentContainer = this.element.querySelector(".component-container"), this.expandTriangle = this.element.querySelector(".panel-expand-triangle"), i(36), this.draw = function() {
        return document.body.appendChild(this.element), t._copyAllButton = t.element.querySelector("div.copy-all"), this.callDrawCallbacks(), t.element
      }, this.expand = function() {
        this.element.classList.remove("collapsed"), this.expandTriangle.classList.add("expanded"), this.resize(this.resizedWidth), this.isCollapsed = !1, i(1).save()
      }, this.collapse = function() {
        this.element.classList.add("collapsed"), this.element.style.width = "", this.expandTriangle.classList.remove("expanded"), this.isCollapsed = !0, i(1).save()
      }, this.toggle = function() {
        this.element.classList.contains("collapsed") ? this.expand() : this.collapse()
      }
    }, Tone.extend(Tone.Editor), Tone.Editor.prototype._focusValueElement = function(t) {
      t.setAttribute("data-previous-value", t.innerHTML), t.setAttribute("contenteditable", !0), t.focus(), document.execCommand("selectAll", !1, null)
    }, Tone.Editor.prototype.deferred = [], Tone.Editor.prototype.deferUntilDrawn = function(t) {
    ...
    var g = Tone.Editor;
    Tone.Editor = new g, t.exports = Tone.Editor
  }.apply(e, g)) && (t.exports = s)
}, function(t, e, i) {
  var g, s;
  g = [i(0), i(2), i(1)], void 0 !== (s = function(e, g, s) {
    function I(t) {
      if (n.isActive && null !== n.target && void 0 !== t) {
        var e = Tone.Frequency(12 * n.octave + t, "midi");
        n.lastNote = e, n.element.querySelector('rect[data-index="' + t + '"]').classList.add("note-playing"), void 0 === r[e] && (r[e] = !0, o.innerHTML = e.toNote() + "<br>" + e.toMidi(), n.target.toneComponent.triggerAttack(e), n._onNoteStart.forEach(function(t) {
          t({
            name: n.target.name,
            target: n.target.toneComponent,
            octave: n.octave,
            note: n.lastNote
          })
        }))
    ...
    function A(t) {
      if (n.isActive && null !== n.target && void 0 !== t) {
        n.element.querySelector('rect[data-index="' + t + '"]').classList.remove("note-playing");
        var e = Tone.Frequency(12 * n.octave + t, "midi");
        !0 === r[e] && (n.target.toneComponent.triggerRelease(e, "+0").triggerRelease(), r[e] = void 0, n._onNoteEnd.forEach(function(t) {
          t({
            name: n.target.name,
            target: n.target.toneComponent,
            octave: n.octave,
    ...
    var n = (i(1), {
        ...
        isVisible: !1,
        show: function() {
          return this.isVisible = !0, Tone.Editor.element.classList.add("keyboard-visible"), this
        },
        hide: function() {
          return this.isVisible = !1, Tone.Editor.element.classList.remove("keyboard-visible"), this
        },
        toggle: function() {
          return this.isVisible ? this.hide() : this.show(), this
        },
        setTarget: function(t) {
          return null !== this.target && this.removeTarget(), this.target = t, this
        },
        removeTarget: function() {
          return this.target && (this.target.keyboardTargetButton.classList.remove("active"), this.target = null), this
        },
        activate: function() {
          return this.isActive = !0, this.target && this.target.keyboardTargetButton.classList.add("active"), this
        },
        deactivate: function() {
          return this.isActive = !1, this.target && this.target.keyboardTargetButton.classList.remove("active"), this
        },
        _onNoteStart: [],
        _onNoteEnd: []
      }),
    ...
    n.octave = 4;
    var o = Tone.Editor.element.querySelector(".note-name");
    n.lastNote = void 0;
    var r = {};
    ...
    }), n.element.addEventListener("mousedown", function(t) {
      if (t.target.classList.contains("key")) {
        I(parseInt(t.target.getAttribute("data-index")))
      }
    }), n.element.addEventListener("mouseup", function(t) {
      if (t.target.classList.contains("key")) {
        A(parseInt(t.target.getAttribute("data-index")))
      }
    }), t.exports = n
  }.apply(e, g)) && (t.exports = s)
}, function(t, e, i) {
  var g, s;
  g = [i(0), i(2), i(3), i(5)], void 0 !== (s = function(e, i, g, s) {
    var I = function(t, i, g, s) {
      this.parentComponent = i, this.parentToneComponent = i.toneComponent, this.name = t, this.toneParameter = this.parentToneComponent[t], this.overwritten = !1, this.initialized = !1, this.element = void 0, this.id = i.id + "_" + t;
      var I = this;
      this.isSignal = e.isSignal(I.toneParameter)
    };
  ...
  var g, s;
  g = [i(0), i(2), i(4), i(1), i(3)], void 0 !== (s = function(e, g, s, I, A) {
    function n(t, g, s, C) {
      var C = C || {};
      this.name = t, this.id = this.name, this.heritage = s, this.class = this.heritage[1] || this.heritage[0] || "", this.isSubcomponent = C.isSubcomponent || !1, this.parentComponent = C.parentComponent || void 0, this.toneComponent = g;
      var o = this;
      this.deferred = [];
      var r = document.createElement("div");
      this.isSubcomponent ? (this.expanded = !1, r.innerHTML = i(28), this.element = r.firstElementChild) : (this.expanded = !0, "Master" === this.name ? r.innerHTML = i(27) : r.innerHTML = i(26), this.element = r.firstElementChild, C.color && (this.element.style.background = C.color), this.keyboardTargetButton = this.element.querySelector(".keyboard-target-button"), "Instrument" !== this.heritage[0] && this.keyboardTargetButton.remove(), this.element.querySelector(".copy-button").setAttribute("data-component-id", this.id)), this.expandTriangle = this.element.querySelector(".expand-triangle"), this.element.addEventListener("click", function(t) {
        var e = t.target.classList;
        e.contains("keyboard-target-button") ? (A.isActive ? A.deactivate().removeTarget() : A.setTarget(o).activate().show(), I.save()) : e.contains("expand-triangle") && t.target === o.expandTriangle && (o.expanded ? o.collapse() : o.expand(), I.save())
      }), r.querySelector(".component-name").innerHTML = this.name, r.querySelector(".component-class").innerHTML = this.class, this.parameterGroupElement = this.element.querySelector(".parameter-group"), this.components = [];
      var o = this,
        a = g.get();
      this.parameters = [], this.subComponents = [], this.subComponentsByName = {};
      var h = o.toneComponent;
      g instanceof Tone.PolySynth && (this.isPolySynth = !0, h = o.toneComponent.voices[0]), e.iterate(a, function(t, g) {
        if ("object" == typeof g && !1 === o.isSubcomponent) {
          var s = {
              isSubcomponent: !0,
              parentComponent: o
            },
            I = e.classify(h[t]),
            A = new n(t, h[t], I, s);
          o.subComponents.push(A), o.subComponentsByName[t] = A
        } else if ("array" == typeof g);
        else if ("number" == typeof g) {
          var C = e.getMeta(t, h[t], o);
          if ("hidden" === C.uiType);
          else {
            var r = i(17)("./" + C.uiType.capitalize() + ".js");
            o.parameters.push(new r(t, o, C, s))
          }
    ...
    n.prototype.deferUntilDrawn = function(t) {
      this.deferred.push(t)
    }, n.prototype.expand = function() {
      this.element.classList.add("expanded"), this.expandTriangle.classList.add("expanded"), this.expanded = !0
    }, n.prototype.collapse = function() {
      this.element.classList.remove("expanded"), this.expandTriangle.classList.remove("expanded"), this.expanded = !1
    }, n.prototype.draw = function() {
      var t = this;
      return this.parameters.forEach(function(e) {
        t.parameterGroupElement.appendChild(e.draw())
      }), this.subComponents.forEach(function(e) {
        t.parameterGroupElement.appendChild(e.draw())
      }), g.masterShown ? g.componentContainer.insertBefore(this.element, g.componentsById.Master.element) : g.componentContainer.appendChild(this.element), this.deferred.forEach(function(t) {
        t()
      }), this.element
    }, n.prototype.update = function() {
      this.parameters.forEach(function(t) {
        t.applyValue(t.getValue())
  ...
  var g, s;
  g = [i(22), i(2), i(0), i(1), i(5)], void 0 !== (s = function(t, e, i, g, s) {
    s.prototype.toString = function(t, e) {
      var t = t || i._options.minify,
        g = g || i._options.useSettingsObjects,
        s = (this.toneComponent.get(), {});
      if (this.parameters.forEach(function(t) {
          s[t.name] = t.parentComponent.toneComponent.get(t.name)[t.name]
        }), this.subComponents.forEach(function(t) {
          s[t.name] = {}, t.parameters.forEach(function(e) {
            s[t.name][e.name] = e.parentComponent.toneComponent.get(e.name)[e.name]
          })
        }), t) var I = JSON.stringify(s);
      else var I = JSON.stringify(s, null, 2);
      return g && (I = "var " + this.name + "Settings=\n" + I), I
    }, Tone.Editor.deferUntilDrawn(function() {
      new t(".tone-editor_container .copy-button", {
        text: function(t) {
          var e = "";
          if (t.classList.contains("copy-all")) i.components.forEach(function(t) {
            e += "var " + t.id + "Settings = " + t.toString(!0, !0) + ";\n\n"
          });
          else {
            var g = t.getAttribute("data-component-id"),
              s = i.componentsById[g];
            e += "var " + g + "Settings = " + s.toString() + ";"
          }
          return t.innerHTML = "✔️", t.style = "-webkit-animation: copy-button-animation 0.5s forwards; animation: copy-button-animation 0.5s forwards;", setTimeout(function() {
            t.innerHTML = "📋", t.style = ""
          }, 500), e
        }
      })
      ...
      var g = this._options.filename;
      e.downloadTextFile(g, t)
    }
  }.apply(e, g)) && (t.exports = s)
}, function(t, e, i) {
  var g, s;
  g = [i(0), i(4)], void 0 !== (s = function(e, g) {
    function s(t, e, s, I) {
      var A = this;
      g.call(this, t, e, s, I);
      var n = document.createElement("div");
      n.innerHTML = i(30), n.querySelector(".parameter-name").innerHTML = this.name, this.element = n.firstElementChild, this.element.setAttribute("id", this.id), this.valueElement = this.element.querySelector("div.value"), this.menuElement = this.element.getElementsByTagName("select")[0];
      var C = "";
      s.menuItems = s.menuItems || [], s.menuItems.forEach(function(t) {
        C += '<option value="' + t + '">' + t + "</option>"
      }), this.menuElement.innerHTML = C, this.valueElement.addEventListener("keydown", function(t) {
        if (13 === t.keyCode) {
          var e = this.innerHTML;
          A.applyValue(e), A.valueElement.setAttribute("contenteditable", !1)
        }
      }), this.menuElement.onchange = function() {
        A.applyValue(this.value), this.blur()
      }, this.applyValue = function(t) {
        !0 === A.initialized && !1 === A.overwritten && (A.element.classList.add("overwritten"), ToneEditor._editedParameters.push(ui), ToneEditor._updateEditCount(), A.overwritten = !0);
        for (var e = this.menuElement.children, i = 0; i < e.length; i++) e[i].value === t ? e[i].setAttribute("selected", "") : e[i].removeAttribute("selected");
        this.parentComponent.isSubcomponent ? A.parentComponent.parentComponent.toneComponent.set(A.parentComponent.name + "." + A.name, t) : A.parentToneComponent.set(A.name, t), this.valueElement.innerHTML = t
      }, this.applyValue(this.getValue())
    }
    s.prototype = g.prototype, t.exports = s
  }.apply(e, g)) && (t.exports = s)
}, function(t, e, i) {
  var g, s;
  g = [i(0), i(9), i(3)], void 0 !== (s = function(e, i, g, s) {
    function I(t, e, g, s) {
      i.call(this, t, e, g, s), this.parentComponent = e, this.element.classList.add("scrubber")
    }
    I.prototype = i.prototype, t.exports = I
  }.apply(e, g)) && (t.exports = s)
}, function(t, e, i) {
  var g, s;
  g = [i(0), i(4), i(3)], void 0 !== (s = function(e, g, s) {
    function I(t, I, A, n) {
      g.call(this, t, I, A, n), this.parentComponent = I, this.nxWidget = !1;
      var C = this;
      this.applyValue = function(t, e) {
        !0 === C.initialized && !1 === C.overwritten && (C.element.addClass("overwritten"), C.overwritten = !0), A.integer && (t = Math.round(t)), this.parentComponent.isSubcomponent ? C.parentComponent.parentComponent.toneComponent.set(C.parentComponent.name + "." + C.name, t) : C.parentToneComponent.set(C.name, t), e || C.nxWidget.set({
          value: t
        }), C.valueElement.innerHTML = nx.prune(t, 2)
      }, this.element = e.nodeFromString(i(31)), this.element.querySelector(".parameter-name").innerHTML = this.name, this.element.querySelector(".unit").innerHTML = A.unit, this.element.setAttribute("id", this.id), this.isSignal && this.element.classList.add("signal"), this.parentComponent.deferUntilDrawn(function() {
        C.nxWidget = nx.add(A.uiType, {
          parent: C.element,
          name: C.id + "_slider",
          w: "100%",
          h: "100%"
          ...
          min: A.min,
          max: A.max,
          canvas: C.element.querySelector("canvas")
        }), C.nxWidget.on("value", function(t) {
          C.applyValue(t, !0), C.valueElement.setAttribute("contenteditable", !1)
        });
        var t = C.getValue();
        C.applyValue(t), C.initialized = !0
      }), this.valueElement = this.element.querySelector("div.value"), this.valueElement.addEventListener("mouseover", function(t) {
        Tone.Editor.mouseIsDown && t.preventDefault()
      }), this.valueElement.addEventListener("keydown", function(t) {
        switch (t.keyCode) {
          case 13:
            var e = C.valueElement.innerHTML;
            C.applyValue(parseFloat(e)), C.valueElement.setAttribute("contenteditable", !1);
            break;
          case 8:
            break;
          case 38:
            var i = 1;
            s.shiftIsDown && (i = 10), s.optionIsDown && (i = .1), s.shiftIsDown && s.optionIsDown && (i = 100);
            var e = parseFloat(C.valueElement.innerHTML);
            C.applyValue(e + i), document.execCommand("selectAll", !1, null);
            break;
          case 40:
            var i = 1;
            s.shiftIsDown && (i = 10), s.optionIsDown && (i = .1), s.shiftIsDown && s.optionIsDown && (i = 100);
            ...
            break;
          case 27:
            var e = parseFloat(C.valueElement.getAttribute("data-previous-value"));
            C.applyValue(e), C.valueElement.blur(), C.valueElement.setAttribute("contenteditable", !1);
            break;
          default:
            t.keyCode >= 48 && t.keyCode <= 57 || 189 === t.keyCode || 190 === t.keyCode || t.preventDefault()
        }
      })
    }
    I.prototype = g.prototype, t.exports = I
  }.apply(e, g)) && (t.exports = s)
}, function(t, e, i) {
  var g, s;
  g = [i(0), i(4)], void 0 !== (s = function(e, g) {
    function s(t, e, s, I) {
      ...
      g.call(this, t, e, s, I);
      var n = document.createElement("div");
      n.innerHTML = i(32), n.querySelector(".parameter-name").innerHTML = this.name, this.element = n.firstElementChild, this.element.setAttribute("id", this.id), this.valueElement = this.element.querySelector("input.toggle"), this.valueElement.onchange = function() {
        A.applyValue(this.checked, !0)
      }, this.applyValue = function(t, e) {
        !0 === A.initialized && !1 === A.overwritten && (A.element.classList.add("overwritten"), A.overwritten = !0), this.parentComponent.isSubcomponent ? A.parentComponent.parentComponent.toneComponent.set(A.parentComponent.name + "." + A.name, t) : A.parentToneComponent.set(A.name, t), e || (A.valueElement.checked = t)
      }, this.applyValue(this.getValue())
    }
    s.prototype = g.prototype, t.exports = s
  }.apply(e, g)) && (t.exports = s)
}, function(t, e) {
  t.exports = '<svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="play" fill="#000000"><polygon id="Triangle" points="100 50 0 100 1.42108547e-14 0"></polygon></g></g></svg>'
}, function(t, e, i) {
  var g, s;
  g = [i(0), i(23), i(2), i(1), i(14), i(15), i(13), i(3), i(6)], void 0 !== (s = function(t, e, i, g, s) {
    i.initialized = !1, i.init = function() {
      ! function() {
        nx.colorize("accent", "#FFF"), nx.colorize("fill", "rgba(0,0,0,0)"), nx.colorize("white", "rgba(0,0,0,0)"), nx.globalWidgets = !1
      }();
      s();
      i.draw(), g.get(), i.initialized = !0
    }
  }.apply(e, g)) && (t.exports = s)
}, function(t, e, i) {
  var g, s;
  g = [i(0), i(2), i(1), i(5), i(3), i(6)], void 0 !== (s = function(e, g, s, I, A, n) {
    g.add = function(t, A, n) {
      function C(t, A) {
        var A = A || o(),
          C = e.classify(t),
          r = {};
        if (n && (r.color = n), C.includes("Transport")) var a = i(16),
          h = new a(A, t, C, r);
        else if (C.includes("Master")) var h = new I(A, t, C, r);
        else {
          if (!(t instanceof Tone)) return void console.log("%cIgnored unsupported Tone object", "color: DarkOrange", t);
          var h = new I(A, t, C, r)
        }
        g.components.push(h), g.componentsById[A] = h, h.draw(), s.get()
      }

      function o() {
        return "component-" + g.components.length
      }
      if (g.initialized || g.init(), null !== t && "object" == typeof t)
        if (t instanceof Tone) C(t);
        else {
          var n = arguments[1];
          for (var r in t) C(t[r], r)
        }
      else C(A, t);
      return g
    }, g.remove = function(t) {
      return "string" == typeof t && void 0 !== g.componentsById[t] && (delete g.componentsById[name], g.components.forEach(function(e, i) {
        e.name === t && g.components.splice(i, 1)
      })), s.save(), g
    }, g.show = function() {
      return g.initialized || g.init(), g.element.classList.remove("hidden"), g
    }, g.hide = function() {
      return g.initialized || g.init(), g.element.classList.add("hidden"), g
    }, g.master = function(t) {
      return g.add("Master", Tone.Master, t || "skyblue"), g
    }, g.transport = function(t, e, i) {
      return t && (g._options.transportScrubIn = Tone.Time(t).toSeconds()), e && (g._options.transportScrubOut = Tone.Time(e).toSeconds()), g.add("Transport", Tone.Transport, i || "orange"), g
    }, g.options = function(t) {
      return e.extend(this._options, t), "right" === t.align ? g.element.classList.add("align-right") : "left" === t.align && g.element.classList.remove("align-right"), g
    }, g.on = function(t, e) {
      "notestart" === t ? A._onNoteStart.push(e) : "noteend" === t && A._onNoteEnd.push(e)
    }, t.exports = g
  }.apply(e, g)) && (t.exports = s)
}, function(t, e, i) {
  var g, s;
  g = [i(0), i(2), i(3)], void 0 !== (s = function(e, i, g) {
    var s = function() {
      i.element.addEventListener("click", function(t) {
        ...
        t.target.hasClass("value") && i._focusValueElement(t.target)
      }), i.element.addEventListener("mousedown", function(t) {
        i.element.addClass("mouse-down"), i._mouseIsDown = !0
      }), i.element.addEventListener("mouseup", function(t) {
        i.element.removeClass("mouse-down"), i._mouseIsDown = !1
      })
    };
    t.exports = s
  }.apply(e, g)) && (t.exports = s)
  ...
  var g, s;
  g = [i(2), i(0), i(1)], void 0 !== (s = function(e, i, g) {
    var s = document.createElement("div");
    s.classList.add("resize-handle"), e.element.appendChild(s);
    var I, A, n, C = !1;
    e.resize = function(t) {
      return t >= e._options.minPanelWidth && (e.element.style.width = t + "px", e.resizedWidth = t), t >= 2 * e._options.columnWidth ? e.componentContainer.classList.add("multi-column") : e.componentContainer.classList.remove("multi-column"), this
    }, document.addEventListener("mousemove", function(t) {
      if (C) {
        I = t.clientX;
        var s = i.getWindowSize().width;
        "right" === e._options.align ? (A = s - I) <= 272 && (A = 272) : "left" === e._options.align && (A = I), e.resize(A), clearTimeout(n), n = setTimeout(function() {
          g.save()
        }, 500)
      }
    }, !1), document.addEventListener("mousedown", function(t) {
      t.target.classList.contains("resize-handle") && (e.element.classList.remove("transition-width"), C = !0)
    }, !1), document.addEventListener("mouseup", function() {
      C && (e.element.classList.add("transition-width"), C = !1)
    }, !1), t.exports = e
  }.apply(e, g)) && (t.exports = s)
}, function(t, e, i) {
  var g, s;
  g = [i(0), i(2), i(5), i(8), i(3)], void 0 !== (s = function(e, g, s, I, A) {
    function n(t, A, n, C) {
      var o = this;
      s.call(this, t, A, n, C), this.element.classList.add("transport"), this.scrubber = new I("seconds", this, e.getMeta("seconds", Tone.Transport.seconds, this)), this.deferUntilDrawn(function() {
        o.scrubber.nxWidget.min = g._options.transportScrubIn, o.scrubber.nxWidget.max = g._options.transportScrubOut
      }), this.scrubber.element.querySelector(".parameter-name").innerHTML = "progress", this.scrubber.element.querySelector(".unit").remove();
      var r = Tone.Time(g._options.transportScrubOut).toBarsBeatsSixteenths();
      this.scrubber.applyValue = function(t, e) {
        Tone.Transport.set("seconds", t), e || void 0 === this.nxWidget || this.nxWidget.set({
          value: t
        });
        var i = Tone.Time(t).toBarsBeatsSixteenths(),
          g = i.split(":");
        g[2] = parseInt(g[2]);
        var s = g.join(":");
        this.valueElement.innerHTML = s + "/" + r
      ...
      this.element.addEventListener("mousedown", function() {
        ...
        !1 === a && o.scrubber.applyValue(Tone.Transport.seconds)
      }, "0.01"), this.controlCluster = e.nodeFromString(i(33)), this.controlCluster.insertBefore(this.scrubber.element, this.buttonRow), this.buttonRow = this.controlCluster.children[0], this.buttonRow.children[0].style["font-size"] = "13px", this.element.insertBefore(this.controlCluster, this.element.children[1]), this.controlCluster.style.marginBottom = "4px";
      var h = this.element.querySelector(".play-pause");
      this.buttonRow.addEventListener("click", function(t) {
        var e = t.target.classList;
        if (e.contains("play-pause")) {
          var i = Tone.Transport.state;
          "started" === i ? Tone.Transport.pause() : "paused" === i ? Tone.Transport.start() : "stopped" === i && Tone.Transport.start()
        } else e.contains("rewind") && (Tone.Transport.stop(), o.scrubber.applyValue(0))
    ...
    n.prototype = s.prototype, t.exports = n
  }.apply(e, g)) && (t.exports = s)
}, function(t, e, i) {
  function g(t) {
    return i(s(t))
  ...
  }, g.resolve = s, t.exports = g, g.id = 17
}, function(t, e, i) {
  var g;
  void 0 !== (g = function() {
    function e(t) {
      var e = [];
      for (var s in i)
        if (t instanceof Tone[s]) {
          e.push(s);
          for (var I = 0; I < i[s].length; I++) t instanceof Tone[i[s][I]] && e.push(i[s][I])
        } if (0 === e.length)
        for (var I = 0; I < g.length; I++) t instanceof Tone[g[I]] && e.push(g[I]);
      return 0 === e.length && (t === Tone.Transport ? e = ["Transport"] : t === Tone.Master && (e = ["Master"])), e
    }
    var i = {
      ...
      g = [];
    g.push("AmplitudeEnvelope", "Analyser", "Compressor", "CrossFade", "EQ3", "Envelope", "FeedbackCombFilter", "Filter", "Follower", "FrequencyEnvelope", "Gate", "LFO", "Limiter", "LowpassCombFilter", "Merge", "Meter", "MidSideCompressor", "MidSideMerge", "MidSideSplit", "Mono", "MultibandCompressor", "MultibandSplit", "PanVol", "Panner", "Panner3D", "ScaledEnvelope", "Split", "Volume"), g.push("Abs", "Add", "AudioToGain", "EqualPowerGain", "Expr", "GainToAudio", "GreaterThan", "GreaterThanZero", "Modulo", "Multiply", "Negate", "Normalize", "Pow", "Scale", "ScaleExp", "Signal", "SignalBase", "Subtract", "TimelineSignal", "WaveShaper", "Zero"), t.exports = e
  }.call(e, i, e, t)) && (t.exports = g)
}, function(t, e, i) {
  var g;
  void 0 !== (g = function() {
    var e = {
    ...
    t.exports = function(t, s, I) {
      if ("object" == typeof t) var A = t.name,
        s = t.toneParameter,
        I = t.parentComponent;
      else var A = t;
      var n = i[I.heritage[1]] || i[I.heritage[2]] || i[I.heritage[0]];
      return void 0 !== n && void 0 !== n[A] ? n[A] : void 0 !== g[s.units] ? g[s.units] : void 0 !== e[A] ? e[A] : e.default
    }
  }.call(e, i, e, t)) && (t.exports = g)
}, function(t, e, i) {
  var g, s;
  ! function(I, A) {
    g = A, void 0 !== (s = "function" == typeof g ? g.call(e, i, e, t) : g) && (t.exports = s)
  }(0, function() {
    function t(t) {
    ...
    function i(i, g) {
      return g && !0 === g.clone && t(i) ? I(e(i), i, g) : i
    }

    function g(e, g, s) {
      var A = e.slice();
      return g.forEach(function(g, n) {
        void 0 === A[n] ? A[n] = i(g, s) : t(g) ? A[n] = I(e[n], g, s) : -1 === e.indexOf(g) && A.push(i(g, s))
      }), A
    }
    ...
    function s(e, g, s) {
      ...
      return t(e) && Object.keys(e).forEach(function(t) {
        ...
        t(g[n]) && e[n] ? A[n] = I(e[n], g[n], s) : A[n] = i(g[n], s)
      }), A
    }
    ...
    function I(t, e, I) {
      var A = Array.isArray(e),
        ...
        C = n.arrayMerge || g;
      return A ? Array.isArray(t) ? C(t, e, I) : i(e, I) : s(t, e, I)
    }
  ...
  void 0 !== (g = function() {
    t.exports = function(t) {
      return t instanceof Tone.Signal
    }
  }.call(e, i, e, t)) && (t.exports = g)
}, function(t, e, i) {
  var g, g;
  ...
  ! function(e) {
    ...
    return function t(e, i, s) {
      ...
      for (var A = "function" == typeof g && g, n = 0; n < s.length; n++) I(s[n]);
      return I
    }({
      1: [function(t, e, i) {
        function g(t, e) {
      ...
      2: [function(t, e, i) {
        function g(t, e, i, g, I) {
          var A = s.apply(this, arguments);
          return t.addEventListener(i, A, I), {
            destroy: function() {
              t.removeEventListener(i, A, I)
            }
          }
        }
        ...
        function s(t, e, i, g) {
          return function(i) {
            i.delegateTarget = I(i.target, e), i.delegateTarget && g.call(t, i)
          }
        }
        var I = t("./closest");
        e.exports = g
      ...
      4: [function(t, e, i) {
        function g(t, e, i) {
          ...
          if (n.node(t)) return s(t, e, i);
          if (n.nodeList(t)) return I(t, e, i);
          if (n.string(t)) return A(t, e, i);
      ...
      5: [function(t, e, i) {
        function g(t) {
          ...
          if ("SELECT" === t.nodeName) t.focus(), e = t.value;
            ...
            s.selectNodeContents(t), g.removeAllRanges(), g.addRange(s), e = g.toString()
          }
          return e
        }
        e.exports = g
      ...
      6: [function(t, e, i) {
        ...
        g.prototype = {
          ...
          once: function(t, e, i) {
            function g() {
              s.off(t, g), e.apply(i, arguments)
            }
            var s = this;
            return g._ = e, this.on(t, g, i)
          },
          emit: function(t) {
            var e = [].slice.call(arguments, 1),
              ...
              g = 0,
              s = i.length;
            for (g; g < s; g++) i[g].fn.apply(i[g].ctx, e);
            return this
          },
          off: function(t, e) {
            var i = this.e || (this.e = {}),
              ...
              s = [];
            if (g && e)
              for (var I = 0, A = g.length; I < A; I++) g[I].fn !== e && g[I].fn._ !== e && s.push(g[I]);
      ...
      7: [function(e, i, g) {
        ! function(s, I) {
          ...
          else if (void 0 !== g) I(i, e("select"));
          else {
            var A = {
              exports: {}
            };
            I(A, s.select), s.clipboardAction = A.exports
          }
        }(this, function(t, e) {
          "use strict";
            ...
            A = function() {
              ...
              return I(t, [{
                ...
                value: function() {
                  ...
                  this.fakeElem.style.top = i + "px", this.fakeElem.setAttribute("readonly", ""), this.fakeElem.value = this.text, document.body.appendChild(this.fakeElem), this.selectedText = (0, g.default)(this.fakeElem), this.copyText()
                }
              }, {
                key: "removeFake",
                value: function() {
                ...
                key: "selectTarget",
                value: function() {
                  this.selectedText = (0, g.default)(this.target), this.copyText()
                }
              }, {
                key: "copyText",
                value: function() {
      ...
      8: [function(e, i, g) {
        ! function(s, I) {
          ...
          else if (void 0 !== g) I(i, e("./clipboard-action"), e("tiny-emitter"), e("good-listener"));
          else {
            var A = {
              exports: {}
            };
            I(A, s.clipboardAction, s.tinyEmitter, s.goodListener), s.clipboard = A.exports
          }
        }(this, function(t, e, i, g) {
          "use strict";
          ...
          var o = s(e),
            ...
            l = function(t) {
              function e(t, i) {
                I(this, e);
                var g = A(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this));
                return g.resolveOptions(i), g.listenClick(t), g
              }
              return n(e, t), h(e, [{
                key: "resolveOptions",
                value: function() {
  ...
  (function(global) {
    var require, require, __WEBPACK_AMD_DEFINE_RESULT__;
    ! function t(e, i, g) {
      function s(A, n) {
        if (!i[A]) {
          if (!e[A]) {
            var C = "function" == typeof require && require;
            if (!n && C) return require(A, !0);
            if (I) return require(A, !0);
          ...
          e[A][0].call(r.exports, function(t) {
            var i = e[A][1][t];
            return s(i || t)
          }, r, r.exports, t, e, i, g)
        }
      ...
      for (var I = "function" == typeof require && require, A = 0; A < g.length; A++) s(g[A]);
      return s
    }({
      1: [function(t, e, g) {
        var s = t("./lib/core/manager"),
          I = t("./lib/utils/dom"),
          A = t("./lib/utils/drawing"),
          n = t("./lib/utils/math"),
          C = t("extend"),
          o = t("webfontloader");
        window.nx = new s, window.nx.onload = function() {}, window.nx = C(window.nx, I), window.nx = C(window.nx, A), window.nx = C(window.nx, n), window.onload = function() {
          try {
            o.load({
              google: {
                families: ["Open Sans"]
          ...
          for (i = 0; i < t.length; i++) nx.transform(t[i]);
      ...
      2: [function(t, e, g) {
        ...
        var s = (t("../utils/timing"), t("../utils/drawing")),
          ...
          C = e.exports = function() {
            I.apply(this), this.widgets = new Object, this.elemTypeArr = new Array, this.aniItems = new Array, this.showLabels = !1, this.starttime = (new Date).getTime(), n && (this.sendsTo = n.setGlobalTransmit, this.setAjaxPath = n.setAjaxPath, this.destination = "js", this.ajaxPath = "lib/nexusOSCRelay.php"), this.isTouchDevice = "ontouchstart" in document.documentElement, this.metas = document.getElementsByTagName("meta"), this.globalWidgets = !0, this.font = "'open sans'", this.fontSize = 14, this.fontWeight = "normal";
            var t = window.AudioContext || window.webkitAudioContext;
            this.context = new t, this.sys = navigator.userAgent.toLowerCase(), this.isAndroid = this.sys.indexOf("android") > -1, this.isMobile = this.sys.indexOf("mobile") > -1, this.throttlePeriod = 20, this.colors.borderhl = s.shadeBlendConvert(-.5, this.colors.border), this.colors.accenthl = s.shadeBlendConvert(.15, this.colors.accent)
          };
        A.inherits(C, I), C.prototype.add = function(t, e) {
          if (t) {
            var i = document.createElement("canvas");
            if (i.setAttribute("nx", t), e) {
              if ((e.x || e.y) && (i.style.position = "absolute"), e.x && (i.style.left = e.x + "px"), e.y && (i.style.top = e.y + "px"), e.w && (i.style.width = e.w, "string" != typeof e.w && (i.width = e.w)), e.h && (i.style.height = e.h, "string" != typeof e.h && (i.height = e.h)), e.parent) {
                var g;
                "string" == typeof e.parent ? g = document.getElementById(e.parent) : e.parent instanceof HTMLElement ? g = e.parent : e.parent instanceof jQuery && (g = e.parent[0])
              }
              e.name && (i.id = e.name)
            }
            if (!g) var g = document.body;
            return g.appendChild(i), this.transform(i)
          }
        }, C.prototype.transform = function(e, i) {
          for (var g in nx.widgets)
            if (nx.widgets[g].canvasID == e.id) return;
          if (i) var s = i;
          else var s = e.getAttribute("nx");
          if (s) {
            var I, A = 0;
            for (j = 0; j < this.elemTypeArr.length; j++) this.elemTypeArr[j] === s && A++;
            if (this.elemTypeArr.push(s), !e.id) {
              var n = A + 1;
              e.id = s + n
            }
            if (s) try {
              var I = new(t("../widgets")[s])(e.id)
            } catch (t) {
              return void console.log("creation of " + s + " failed")
            }
            return I.type = s, this.widgets[I.canvasID] = I, this.globalWidgets && (window[I.canvasID] = this.widgets[I.canvasID]), I.init(), I
          }
        }, C.prototype.transmit = function(t, e) {
          this.makeOSC(this.emit, t, e), this.emit("*", t, e)
        }, C.prototype.colorize = function(t, e) {
          e || (e = t, t = "accent"), this.colors[t] = e, this.colors.borderhl = s.shadeBlendConvert(.1, this.colors.border, this.colors.black), this.colors.accenthl = s.shadeBlendConvert(.3, this.colors.accent);
          for (var i in this.widgets) this.widgets[i].colors[t] = e, this.widgets[i].colors.borderhl = this.colors.borderhl, this.widgets[i].colors.accenthl = this.colors.accenthl, this.widgets[i].draw()
        }, C.prototype.setThrottlePeriod = function(t) {
          this.throttlePeriod = t;
          for (var e in this.widgets) this.widgets[e].throttlePeriod = this.throttlePeriod
        }, C.prototype.colors = {
          accent: "#ff5500",
          fill: "#eeeeee",
          border: "#e3e3e3",
          ...
          black: "#000000",
          white: "#FFFFFF"
        }, C.prototype.startPulse = function() {
          this.pulseInt = setInterval("nx.pulse()", 30)
        }, C.prototype.stopPulse = function() {
          clearInterval(this.pulseInt)
        }, C.prototype.pulse = function() {
          for (var t = 0; t < this.aniItems.length; t++) this.aniItems[t]()
        }, C.prototype.addAni = function(t) {}, C.prototype.removeAni = function(t) {
          this.aniItems.splice(this.aniItems.indexOf(t))
        }, C.prototype.addStylesheet = function() {
          var t = 'select {width: 150px;padding: 5px 5px;font-size: 16px;color:#666666;border: solid 2px #e4e4e4;border-radius: 0;-webkit-appearance: none;outline: none;cursor:pointer;background-color:#EEE;font-family:"open sans";}input[type=text]::-moz-selection { background: transparent; }input[type=text]::selection { background: transparent; }input[type=text]::-webkit-selection { background: transparent; }canvas { cursor:pointer;border-radius:0px;moz-border-radius:0px;webkit-border-radius:0px;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;}input[type=text] { border-radius:5px;moz-border-radius:5px;webkit-border-radius:5px;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;}',
            e = document.head,
            i = document.createElement("style");
          i.type = "text/css", i.styleSheet ? i.styleSheet.cssText = t : i.appendChild(document.createTextNode(t)), e.appendChild(i)
        }, C.prototype.setViewport = function(t) {
          for (i = 0; i < this.metas.length; i++) "viewport" == this.metas[i].name && (this.metas[i].content = "minimum-scale=" + t + ", maximum-scale=" + t)
        }, C.prototype.setLabels = function(t) {
          this.showLabels = "on" == t;
          for (var e in this.widgets) this.widgets[e].draw()
        }, C.prototype.setProp = function(t, e) {
          if (t && e) {
            nx[t] = e;
            for (var i in this.widgets) this.widgets[i][t] = e, this.widgets[i].draw()
          }
        }, C.prototype.blockMove = function(t) {
          t.target.attributes.nx && (t.preventDefault(), this.isAndroid && !!t.stopPropagation && t.stopPropagation())
        }, C.prototype.calculateDigits = function(t) {
          var e = this.max ? Math.floor(this.max).toString().length : 1;
          if (e < this.maxdigits) var i = 3 - e;
          else var i = 0;
          return {
            wholes: e,
            decimals: i,
          ...
          blue: "#09d",
          purple: "#40a"
        }, C.prototype.skin = function(t) {
          var e = t.split("-");
          nx.colorize("fill", nx.themes[e[0]].fill), nx.colorize("border", nx.themes[e[0]].border), nx.colorize("black", nx.themes[e[0]].black), nx.colorize("white", nx.themes[e[0]].white), nx.colorize("accent", nx.themes[e[1]]), document.body.style.backgroundColor = nx.themes[e[0]].body
        }, C.prototype.labelSize = function(t) {
          for (var e in this.widgets) {
            var i = this.widgets[e];
            if (i.label) {
              var g = i.GUI.h + t;
              i.labelSize = t, ["select", "number", "text"].indexOf(i.type) < 0 && i.resize(!1, g)
            }
          }
          var s = document.querySelectorAll(".nxlabel");
          console.log(s);
          for (var I = 0; I < s.length; I++) console.log(s[I]), s[I].style.fontSize = t / 2.8 + "px", console.log(s[I].style.fontSize)
        }
      }, {
        "../utils/drawing": 5,
        "../utils/timing": 7,
      ...
      3: [function(require, module, exports) {
        var EventEmitter = require("events").EventEmitter,
          ...
          widget = module.exports = function(t) {
            ...
            if (this.type = void 0, this.canvas = document.getElementById(t), this.context = this.canvas.getContext("2d"), this.checkPercentage(), this.canvas.className = this.canvas.className ? this.canvas.className += " nx" : "nx", this.canvas.height = window.getComputedStyle(document.getElementById(t), null).getPropertyValue("height").replace("px", ""), this.canvas.width = window.getComputedStyle(document.getElementById(t), null).getPropertyValue("width").replace("px", ""), this.height = parseInt(window.getComputedStyle(document.getElementById(t), null).getPropertyValue("height").replace("px", "")), this.width = parseInt(window.getComputedStyle(document.getElementById(t), null).getPropertyValue("width").replace("px", "")), this.defaultSize || (this.defaultSize = {
              ...
              var i = this.width,
                g = this.height;
              this.canvas.width = 2 * i, this.canvas.height = 2 * g, this.width = i, this.height = g
            }
            ...
            for (var s in nx.colors) this.colors[s] = nx.colors[s];
            this.clickPos = {
              x: 0,
              y: 0
        ...
        util.inherits(widget, EventEmitter), widget.prototype.transmit = nx.transmit, widget.prototype.makeOSC = function(t, e) {
          ...
          if (this.clicked) {
            this.actuated = !0;
            var e = domUtils.getTouchPosition(t, this.offset);
            this.deltaMove.y = e.y - this.clickPos.y, this.deltaMove.x = e.x - this.clickPos.x, this.clickPos = e, this.hasMoved = !0, this.touchMove(t)
          }
        ...
        }, widget.prototype.set = function(t, e) {
          if (this.actuated = !1, "object" == typeof this.val && "null" !== this.val) {
            if ("object" == typeof t && "null" !== t)
              for (var i in t) this.val[i] = t[i]
          ...
          this.draw(), e && this.transmit(this.val, !0)
          ...
          e && e.parentNode.removeChild(e), this.customDestroy();
          var i = this.canvasID;
          delete nx.widgets[i], delete window[i]
        }, widget.prototype.customDestroy = function() {}, widget.prototype.wrapText = function(t, e, i, g, s) {
          if (t) {
            for (var I = t.split(" "), A = "", n = 0; n < I.length; n++) {
              var C = A + I[n] + " ";
              this.context.measureText(C).width > g && n > 0 ? (this.context.fillText(A, e, i), A = I[n] + " ", i += s) : A = C
            }
            this.context.fillText(A, e, i)
          }
          ...
          var t = this.canvas.style.width,
            e = this.canvas.style.height;
          (t.indexOf("%") >= 0 || e.indexOf("%") >= 0) && (this.percent = {
            w: t.indexOf("%") >= 0 && t.replace("%", ""),
            h: e.indexOf("%") >= 0 && e.replace("%", "")
          }, this.stretch())
        }, widget.prototype.stretch = function() {
          window.addEventListener("resize", function(t) {
            if (this.percent.w) {
              var e = window.getComputedStyle(this.canvas.parentNode, null).getPropertyValue("width").replace("px", "");
              e *= this.percent.w / 100
            } else var e = !1;
            if (this.percent.h) {
              var i = window.getComputedStyle(this.canvas.parentNode, null).getPropertyValue("height").replace("px", "");
              i *= this.percent.h / 100
            } else var i = !1;
            this.resize(e, i)
          }.bind(this))
        }, widget.prototype.resize = function(t, e) {
          this.canvas.width = t ? 2 * t : this.canvas.width, this.canvas.height = e ? 2 * e : this.canvas.height, this.width = t || this.width, this.height = e || this.height, this.canvas.style.width = this.width + "px", this.canvas.style.height = this.height + "px", this.context.scale(2, 2), this.center = {
            x: this.GUI.w / 2,
            y: this.GUI.h / 2
      ...
      4: [function(t, e, i) {
        i.findPosition = function(t) {
          var e = document.body,
            i = document.defaultView,
            g = document.documentElement,
            s = document.createElement("div");
          s.style.paddingLeft = s.style.width = "1px", e.appendChild(s);
          var I = 2 == s.offsetWidth;
          e.removeChild(s), s = t.getBoundingClientRect();
          var A = g.clientTop || e.clientTop || 0,
            n = g.clientLeft || e.clientLeft || 0,
            C = i.pageYOffset || I && g.scrollTop || e.scrollTop,
            o = i.pageXOffset || I && g.scrollLeft || e.scrollLeft;
          return {
            top: s.top + C - A,
            left: s.left + o - n
          }
        }, i.getCursorPosition = function(t, e) {
          var i, g;
          void 0 != t.pageX && void 0 != t.pageY ? (i = t.pageX, g = t.pageY) : (i = t.clientX + document.body.scrollLeft + document.documentElement.scrollLeft, g = t.clientY + document.body.scrollTop + document.documentElement.scrollTop), i -= e.left, g -= e.top;
          var s = {
            x: i,
            y: g
          };
        ...
        }, i.getTouchPosition = function(t, e) {
          var i, g;
          i = t.targetTouches[0].pageX, g = t.targetTouches[0].pageY, i -= e.left, g -= e.top;
          var s = {
            x: i,
            y: g
          };
          s.touches = new Array;
          for (var I = 0; I < t.targetTouches.length; I++) s.touches.push({
            x: t.targetTouches[I].pageX - e.left,
            y: t.targetTouches[I].pageY - e.top
          });
          s.changed = new Array;
          for (var I = 0; I < t.changedTouches.length; I++) s.changed.push({
            x: t.changedTouches[I].pageX - e.left,
            y: t.changedTouches[I].pageY - e.top
          });
          return s
        }
      }, {}],
      5: [function(require, module, exports) {
        ...
        }, exports.hexToRgb = function(t, e) {
          t = t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function(t, e, i, g) {
            return e + e + i + i + g + g
          });
          var i = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);
          return e || (e = .5), "rgba(" + parseInt(i[1], 16) + "," + parseInt(i[2], 16) + "," + parseInt(i[3], 16) + "," + e + ")"
        }, exports.isInside = function(t, e) {
          return t.x > e.x && t.x < e.x + e.w && t.y > e.y && t.y < e.y + e.h
        }, exports.makeRoundRect = function(t, e, i, g, s, I) {
          var A = e,
            n = i,
            C = g + A,
            o = s + n;
          I || (I = 2), t.beginPath(), t.moveTo(A + I, n), t.lineTo(C - I, n), t.quadraticCurveTo(C, n, C, n + I), t.lineTo(C, o - I), t.quadraticCurveTo(C, o, C - I, o), t.lineTo(A + I, o), t.quadraticCurveTo(A, o, A, o - I), t.lineTo(A, n + I), t.quadraticCurveTo(A, n, A + I, n), t.closePath()
        ...
        }, exports.shadeBlendConvert = function(t, e, i) {
          if ("number" != typeof t || t < -1 || t > 1 || "string" != typeof e || "r" != e[0] && "#" != e[0] || "string" != typeof i && void 0 !== i) return null;
          this.sbcRip = function(t) {
            var e = t.length,
              i = new Object;
            if (e > 9) {
              if (t = t.split(","), t.length < 3 || t.length > 4) return null;
              i[0] = g(t[0].slice(4)), i[1] = g(t[1]), i[2] = g(t[2]), i[3] = t[3] ? parseFloat(t[3]) : -1
            } else {
              switch (e) {
                case 8:
                case 6:
              ...
              e < 6 && (t = "#" + t[1] + t[1] + t[2] + t[2] + t[3] + t[3] + (e > 4 ? t[4] + "" + t[4] : "")), t = g(t.slice(1), 16), i[0] = t >> 16 & 255, i[1] = t >> 8 & 255, i[2] = 255 & t, i[3] = 9 == e || 5 == e ? s((t >> 24 & 255) / 255 * 1e4) / 1e4 : -1
            }
            return i
          };
          var g = parseInt,
            s = Math.round,
            I = e.length > 9,
            I = "string" == typeof i ? i.length > 9 || "c" == i && !I : I,
            A = t < 0,
            t = A ? -1 * t : t,
            i = i && "c" != i ? i : A ? "#000000" : "#FFFFFF",
            n = this.sbcRip(e),
            C = this.sbcRip(i);
          return n && C ? I ? "rgb(" + s((C[0] - n[0]) * t + n[0]) + "," + s((C[1] - n[1]) * t + n[1]) + "," + s((C[2] - n[2]) * t + n[2]) + (n[3] < 0 && C[3] < 0 ? ")" : "," + (n[3] > -1 && C[3] > -1 ? s(1e4 * ((C[3] - n[3]) * t + n[3])) / 1e4 : C[3] < 0 ? n[3] : C[3]) + ")") : "#" + (4294967296 + 16777216 * (n[3] > -1 && C[3] > -1 ? s(255 * ((C[3] - n[3]) * t + n[3])) : C[3] > -1 ? s(255 * C[3]) : n[3] > -1 ? s(255 * n[3]) : 255) + 65536 * s((C[0] - n[0]) * t + n[0]) + 256 * s((C[1] - n[1]) * t + n[1]) + s((C[2] - n[2]) * t + n[2])).toString(16).slice(n[3] > -1 || C[3] > -1 ? 1 : 3) : null
        }
      }, {
        "./math": 6
      }],
      6: [function(t, e, i) {
        i.toPolar = function(t, e) {
          var i = Math.sqrt(t * t + e * e),
            g = Math.atan2(e, t);
          return g < 0 && (g += 2 * Math.PI), {
            radius: i,
            angle: g
          }
        }, i.toCartesian = function(t, e) {
          return {
            x: t * Math.cos(e),
            y: t * Math.sin(e) * -1
          }
        }, i.clip = function(t, e, i) {
          return Math.min(i, Math.max(e, t))
        }, i.prune = function(t, e) {
          if ("number" == typeof t) t = parseFloat(t.toFixed(e));
          else if (t instanceof Array)
            for (var i = 0; i < t.length; i++) "number" == typeof t[i] && (t[i] = parseFloat(t[i].toFixed(e)));
          return t
        }, i.scale = function(t, e, i, g, s) {
          return (t - e) * (s - g) / (i - e) + g
        }, i.invert = function(t) {
          return i.scale(t, 1, 0, 0, 1)
        }, i.bounce = function(t, e, i, g) {
          return t > e && t < i ? g : t <= e ? Math.abs(g) : t >= i ? -1 * Math.abs(g) : void 0
        }, i.mtof = function(t) {
          return 440 * Math.pow(2, (t - 69) / 12)
        }, i.random = function(t) {
          return Math.floor(Math.random() * t)
        }, i.interp = function(t, e, i) {
          return t * (i - e) + e
        }, i.lphistory = {}, i.lp = function(t, e, i) {
          this.lphistory[t] || (this.lphistory[t] = []);
          var g = 0;
          this.lphistory[t].push(e), this.lphistory[t].length > i && this.lphistory[t].splice(0, 1);
          for (var s = 0; s < this.lphistory[t].length; s++) g += this.lphistory[t][s];
          return g / this.lphistory[t].length
        }, i.lp2 = function(t, e) {
          for (var i = 0, g = 0; g < this.lphistory.length; g++) i += this.lphistory[g];
          i += t;
          var s = i / (this.lphistory.length + 1);
          return this.lphistory.push(s), this.lphistory.length > e && this.lphistory.splice(0, 1), s
        }, i.lp3 = function(t, e, i) {
          var g = t + e * i;
          return newvalue = g / (i + 1), newvalue
        }
      }, {}],
      7: [function(t, e, i) {
      ...
      8: [function(t, e, i) {
        i.defineTransmit = function(t) {
          ...
          switch (t) {
            ...
            case "ajax":
              return function(t) {
                this.makeOSC(i.ajaxTransmit, t)
              };
            case "node":
              return function(t) {
                this.makeOSC(i.nodeTransmit, t)
              };
            case "ios":
              return function(t) {};
            case "max":
              return function(t) {
                this.makeOSC(i.maxTransmit, t)
              };
            case "wc":
              return function(t, e) {
                this.emit("internal", t, e)
              }
          }
        }, i.setGlobalTransmit = function(t) {
          var e = i.defineTransmit(t);
          this.transmit = e, this.destination = t;
          for (var g in nx.widgets) this.widgets[g].transmit = e, this.widgets[g].destination = t
        }, i.setWidgetTransmit = function(t) {
          var e = i.defineTransmit(t);
          this.transmit = e, this.destination = t
        }, i.ajaxTransmit = function(t, e) {
          var i = "value" == t ? this.oscPath : this.oscPath + "/" + t;
          xmlhttp = new XMLHttpRequest, xmlhttp.open("POST", nx.ajaxPath, !0), xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), xmlhttp.send("oscName=" + i + "&data=" + e)
        }, i.setAjaxPath = function(t) {
          this.ajaxPath = t
        }, i.nodeTransmit = function(t, e) {
          var i = {
            oscName: "value" == t ? this.oscPath : this.oscPath + "/" + t,
            value: e
          };
          socket.emit("nx", i)
        }, i.maxTransmit = function(t, e) {
          var i = "value" == t ? this.oscPath : this.oscPath + "/" + t;
          window.max.outlet(i + " " + e)
        }
      }, {}],
      ...
      11: [function(require, module, exports) {
        ...
        util.inherits(colors, widget), colors.prototype.init = function() {
          ...
          if (this.clickPos.x > 0 && this.clickPos.y > 0 && this.clickPos.x < this.GUI.w && this.clickPos.y < this.GUI.h) {
            var e = this.context.getImageData(2 * this.clickPos.x, 2 * this.clickPos.y, 1, 1);
            this.val = {
              r: e.data[0],
              g: e.data[1],
              b: e.data[2]
      ...
      13: [function(require, module, exports) {
        ...
        util.inherits(crossfade, widget), crossfade.prototype.init = function() {
          ...
          with(this.erase(), this.location = Math.pow(this.val.R, 2), this.context) {
            ...
            fillStyle = this.colors.accent, fillRect(x1, 0, this.GUI.w - x1, y2), textBaseline = "middle", font = this.GUI.h / 3 + "px 'Open Sans'", fillStyle = this.colors.accent, textAlign = "right", fillText(this.val.R.toFixed(2), x1 - 2, this.GUI.h / 4), fillStyle = this.colors.fill, textAlign = "left", fillText(this.val.L.toFixed(2), x1 + 2, .75 * this.GUI.h)
          }
          this.drawLabel()
          ...
          var t = math.clip(this.clickPos.x / this.GUI.w, 0, 1),
            e = 1 - t;
          this.location = t, this.val.R = math.prune(Math.sqrt(t), 3), this.val.L = math.prune(Math.sqrt(e), 3), this.draw(), this.transmit(this.val)
        }
      }, {
        "../core/widget": 3,
        "../utils/math": 6,
      ...
      14: [function(require, module, exports) {
        ...
        util.inherits(dial, widget), dial.prototype.init = function() {
          this.circleSize = Math.min(this.center.x, this.center.y), this.handleLength = this.circleSize, this.mindim = Math.min(this.GUI.w, this.GUI.h), this.mindim < 101 || this.mindim < 101 ? this.accentWidth = 1 * this.lineWidth : this.accentWidth = 2 * this.lineWidth, this.draw()
      ...
      15: [function(require, module, exports) {
        ...
        util.inherits(envelope, widget), envelope.prototype.init = function() {
          ...
          var e = t,
            i = 0,
            g = this.GUI.w,
            s = this.val.points[e].x,
            I = this.GUI.h - this.val.points[e].y,
            A = math.clip(s / this.GUI.w, 0, 1),
            n = math.clip(I / this.GUI.h, 0, 1);
          this.val.points[e].x = math.prune(A, 3), this.val.points[e].y = math.prune(n, 3), e > 0 && (i = this.val.points[e - 1].x), this.val.points.length > e + 1 && (g = this.val.points[e + 1].x), this.val.points[e].x < i && (this.val.points.splice(e - 1, 0, this.val.points.splice(e, 1)[0]), e -= 1, this.selectedNode = e), this.val.points[e].x > g && (this.val.points.splice(e + 1, 0, this.val.points.splice(e, 1)[0]), e += 1, this.selectedNode = e)
          ...
          if (this.active) {
            ...
            if (t >= 1 && (this.looping ? (t -= 1, startTime += this.duration / 1e3, this.val.index = 0, this.scanIndex = 0) : this.stop()), this.val.index = t, this.val.index > this.val.points[this.val.points.length - 1].x) this.val.amp = this.val.points[this.val.points.length - 1].y;
              ...
              var e = this.val.points[this.scanIndex].x,
                i = this.val.points[this.scanIndex - 1].x,
                g = this.val.points[this.scanIndex].y,
                s = this.val.points[this.scanIndex - 1].y;
              this.val.amp = math.interp((this.val.index - i) / (e - i), s, g)
            }
        ...
        }, envelope.prototype.findNearestNode = function(t, e, i) {
          var g = null,
            s = 1e3,
            I = !1;
          e = 1 - e;
          for (var A = 0; A < i.length; A++) {
            var n = Math.sqrt(Math.pow(i[A].x - t, 2), Math.pow(i[A].y - -e, 2));
            n < s && (s = n, g = A, I = t > i[A].x)
          }
          return s > .1 && (I && g++, this.val.points.splice(g, 0, {
      ...
      18: [function(require, module, exports) {
        ...
        util.inherits(keyboard, widget), keyboard.prototype.init = function() {
          ...
          for (var t = 0; t < this.keypattern.length; t++) "w" == this.keypattern[t] && this.white.num++;
          ...
          this.drawLabel()
        }, keyboard.prototype.toggle = function(t, e) {
          if ("button" == this.mode) {
            if (t) {
              t.on = e || !1 === e ? e : !t.on;
              var i = t.on ? 1 : 0,
                g = 128 * math.invert(this.clickPos.y / this.GUI.h);
              g = math.prune(math.clip(g, 5, 128), 0), this.val = {
                on: i * g,
                note: t.note,
                midi: t.note + " " + i
              }, this.transmit(this.val), this.draw()
        ...
        }, keyboard.prototype.whichKey = function(t, e) {
          for (var i in this.bkeys)
            if (drawing.isInside({
                x: t,
                y: e
              }, this.bkeys[i])) return this.bkeys[i];
          var g = ~~(t / this.white.width);
          return g >= this.wkeys.length && (g = this.wkeys.length - 1), g < 0 && (g = 0), this.wkeys[g]
          ...
          if (this.clickPos.touches.length > 1 || this.multitouch) {
            ...
            for (var e = 0; e < this.clickPos.touches.length; e++) this.fingers[e] = {
              key: this.whichKey(this.clickPos.touches[e].x, this.clickPos.touches[e].y)
            }, this.fingers[e].key.on || this.toggle(this.fingers[e].key, !0), this.keysinuse.push(this.fingers[e].key.index);
            for (var e = 0; e < this.keys.length; e++) this.keys[e].on && this.keysinuse.indexOf(this.keys[e].index) < 0 && this.toggle(this.keys[e], !1)
          ...
          if (this.clickPos.touches.length > 1 || this.multitouch) {
            this.keysinuse = new Array;
            for (var e = 0; e < this.clickPos.touches.length && (!this.oneleft || 1 != this.clickPos.touches.length); e++) this.fingers[e] = {
              key: this.whichKey(this.clickPos.touches[e].x, this.clickPos.touches[e].y)
            }, this.keysinuse.push(this.fingers[e].key.index);
            for (var e = 0; e < this.keys.length; e++) this.keys[e].on && this.keysinuse.indexOf(this.keys[e].index) < 0 && this.toggle(this.keys[e], !1);
      ...
      19: [function(require, module, exports) {
        ...
        util.inherits(matrix, widget), matrix.prototype.init = function() {
          this.pmatrix = !!this.matrix && this.matrix, this.matrix = null, this.matrix = new Array(this.col);
          for (var t = 0; t < this.col; t++) {
            this.matrix[t] = new Array(this.row);
            for (var e = 0; e < this.row; e++) this.matrix[t][e] = this.pmatrix && this.pmatrix[t] ? this.pmatrix[t][e] : 0
          }
        ...
        }, matrix.prototype.setCell = function(t, e, i) {
          var g = i ? 1 : 0;
          this.matrix[t][e] = g, this.val = {
            row: e,
            col: t,
            level: g
          }, this.transmit(this.val), this.draw()
          ...
          if (this.bpm != this.pbpm) {
            e = e / (6e4 / this.pbpm) * (6e4 / this.bpm), this.starttime = t - e, this.thisframe = ~~(e / (6e4 / this.bpm))
          } else this.thisframe = ~~(e / (6e4 / this.bpm));
          ...
          if (!this.clicked) {
            ...
            for (var t = 0; t < this.col; t++) {
              ...
              for (var e = 0; e < this.row; e++) {
                var i = 0;
                t - 1 >= 0 && (i += this.matrix[t - 1][e - 1] ? this.matrix[t - 1][e - 1] : 0, i += this.matrix[t - 1][e] ? this.matrix[t - 1][e] : 0, i += this.matrix[t - 1][e + 1] ? this.matrix[t - 1][e + 1] : 0), i += this.matrix[t][e - 1] ? this.matrix[t][e - 1] : 0, i += this.matrix[t][e + 1] ? this.matrix[t][e + 1] : 0, t + 1 < this.col && (i += this.matrix[t + 1][e - 1] ? this.matrix[t + 1][e - 1] : 0, i += this.matrix[t + 1][e] ? this.matrix[t + 1][e] : 0, i += this.matrix[t + 1][e + 1] ? this.matrix[t + 1][e + 1] : 0), this.matrix[t][e] ? i < 2 ? this.newmatrix[t][e] = 0 : 2 == i || 3 == i ? this.newmatrix[t][e] = 1 : i > 3 && (this.newmatrix[t][e] = 0) : this.matrix[t][e] || 3 != i ? this.newmatrix[t][e] = this.matrix[t][e] : this.newmatrix[t][e] = 1
              }
            }
      ...
      20: [function(require, module, exports) {
        ...
        util.inherits(message, widget), message.prototype.init = function() {
          ...
          with(this.erase(), this.context) this.clicked ? fillStyle = this.colors.border : fillStyle = this.colors.fill, fillRect(0, 0, this.GUI.w, this.GUI.h), this.clicked, fillStyle = this.colors.black, textAlign = "left", font = this.size + "px " + nx.font;
      ...
      21: [function(require, module, exports) {
        ...
        util.inherits(meter, widget), meter.prototype.init = function() {
        ...
        }, meter.prototype.setup = function(t, e) {
          this.actx = t, this.source = e, this.analyser = this.actx.createAnalyser(), this.analyser.smoothingTimeConstant = .85, this.analyser.fftsize = 1024, this.bufferLength = this.analyser.frequencyBinCount, this.dataArray = new Uint8Array(this.bufferLength), this.source.connect(this.analyser), this.draw()
          ...
          if (this.dataArray) {
            ...
            var max = Math.max.apply(null, this.dataArray),
              ...
              amp = max - min;
            amp /= 240;
            var db = Math.log(amp) / Math.log(10) * 20;
            with(this.context) {
              fillStyle = this.colors.fill, fillRect(0, 0, this.GUI.w, this.GUI.h);
              for (var dboffset = Math.floor((db + 40) / (50 / this.bars)), i = 0; i < this.bars; i++) i >= .8 * this.bars ? fillStyle = "rgb(255,0,0)" : i < .8 * this.bars && i >= .69 * this.bars ? fillStyle = "rgb(255,255,0)" : i < .69 * this.bars && (fillStyle = "rgb(0,255,0)"), i < dboffset && fillRect(1, this.GUI.h - this.bar.h * i, this.GUI.w - 2, this.bar.h - 2)
            }
          }
          setTimeout(function() {
      ...
      22: [function(require, module, exports) {
        ...
        util.inherits(metro, widget), metro.prototype.init = function() {
          ...
          this.speed, this.loc += this.speed * this.direction, (this.loc - this.nodeSize < 0 || this.loc + this.nodeSize > this.boundary) && (this.val.beat = math.scale(this.direction, -1, 1, 0, 1), this.transmit(this.val), this.direction *= -1), "vertical" == this.orientation ? this.y = this.loc : this.x = this.loc, this.draw()
        ...
        util.inherits(multislider, widget), multislider.prototype.init = function() {
          ...
          if (this.clicked) {
            if (this.clickPos.touches.length > 1)
              for (var e = 0; e < this.clickPos.touches.length; e++) {
                var i = Math.floor(this.clickPos.touches[e].x / this.sliderWidth);
                i = math.clip(i, 0, this.sliders - 1), this.val[i] = math.clip(math.invert(this.clickPos.touches[e].y / this.GUI.h), 0, 1)
              } else {
                var i = Math.floor(this.clickPos.x / this.sliderWidth);
                if (i = math.clip(i, 0, this.sliders - 1), this.val[i] = math.clip(math.invert(this.clickPos.y / this.GUI.h), 0, 1), this.oldSliderToMove && this.oldSliderToMove > i + 1)
                  for (var g = this.oldSliderToMove - i - 1, e = 1; e <= g; e++) this.val[i + e] = this.val[i] + (this.val[this.oldSliderToMove] - this.val[i]) * (e / (g + 1));
                else if (this.oldSliderToMove && i > this.oldSliderToMove + 1)
                  for (var g = i - this.oldSliderToMove - 1, e = 1; e <= g; e++) this.val[this.oldSliderToMove + e] = this.val[this.oldSliderToMove] + (this.val[i] - this.val[this.oldSliderToMove]) * (e / (g + 1))
              }
            this.draw()
          }
          var s = new Object;
          if (s[i] = this.val[i], "js" == this.destination || "node" == this.destination) s.list = this.val;
          else {
            s.list = new String;
            for (var I in this.val) s.list += this.val[I] + " "
          }
          ...
          for (var e = 0; e < this.sliders; e++) this.val.push(.7);
          this.sliderWidth = this.realSpace.x / this.sliders, this.init()
        }, multislider.prototype.setSliderValue = function(t, e) {
          this.val[t] = e, this.draw();
          var i = new Object;
          if (i[t] = this.val[t], "js" == this.destination || "node" == this.destination) i.list = this.val;
          else {
            i.list = new String;
            for (var g in this.val) i.list += this.val[g] + " "
          }
          this.transmit(i)
        }
      }, {
      ...
      26: [function(require, module, exports) {
        ...
        util.inherits(multitouch, widget), multitouch.prototype.init = function() {
          ...
          if (!this.clicked) {
            ...
            for (var t = 0; t < 5; t++) this.val["touch" + t] = {
              x: 0,
              y: 0
            };
            this.transmit(this.val)
      ...
      27: [function(t, e, i) {
        var g = t("../utils/math"),
          ...
          A = e.exports = function(t) {
            ...
            var e = '<input type="text" nx="number" id="' + this.canvasID + '" style="height:' + this.GUI.h + "px;width:" + this.GUI.w + "px;font-size:" + this.GUI.h / 2 + 'px;"></input><canvas height="1px" width="1px" style="display:none"></canvas>',
              i = this.canvas,
              s = this.canvas.style,
              A = i.parentNode,
              n = document.createElement("span");
            n.innerHTML = e, n.className = "nx", A.replaceChild(n, i), this.el = document.getElementById(this.canvasID);
            for (var C in s) "height" != C && "width" != C && (this.el.style[C] = s[C]);
            if (this.label) {
              var o = document.createElement("div");
              o.innerHTML = this.label, o.style.fontSize = this.labelSize / 2.8 + "px", o.style.fontFamily = this.labelFont, o.style.textAlign = this.labelAlign, o.style.lineHeight = this.labelSize + "px", o.style.width = this.GUI.w + "px", o.style.color = nx.colors.black, o.className = "nxlabel", n.appendChild(o)
            }
            this.canvas = document.getElementById(this.canvasID), this.canvas.style.height = this.GUI.h + "px", this.canvas.style.fontSize = .6 * this.GUI.h + "px", this.canvas.style.textAlign = "left", this.canvas.style.backgroundColor = this.colors.fill, this.canvas.style.highlight = this.colors.fill, this.canvas.style.border = "none", this.canvas.style.outline = "none", this.canvas.style.padding = "4px 10px", this.canvas.style.cursor = "pointer", this.canvas.style.display = "block", this.canvas.className = "", this.canvas.addEventListener("blur", function() {
              this.canvas.style.backgroundColor = this.colors.fill, this.canvas.style.color = this.colors.black, this.canvas.value != this.val.value && (this.actual = parseFloat(this.canvas.value), this.actual = g.clip(this.actual, this.min, this.max), this.actual = g.prune(this.actual, this.decimalPlaces), this.set({
                value: this.actual
              }, !0))
        ...
        s.inherits(A, I), A.prototype.init = function() {
          this.draw()
          ...
          this.clicked && (this.canvas.style.border = "none", this.actual -= this.deltaMove.y * (this.rate * this.step), this.actual = g.clip(this.actual, this.min, this.max), this.val.value = Math.floor(this.actual / this.step) * this.step, this.val.value = g.prune(this.val.value, this.decimalPlaces), this.draw(), this.transmit(this.val))
      ...
      28: [function(require, module, exports) {
        ...
        util.inherits(position, widget), position.prototype.init = function() {
          ...
          var t = this.val.x - this.nodeSize,
            e = this.val.y - this.nodeSize,
            i = math.clip(t / this.actualWid, 0, 1),
            g = math.clip(e / this.actualHgt, 0, 1);
          this.val.x = math.prune(i, 3), this.val.y = math.prune(g, 3), this.val.y = math.invert(this.val.y)
        ...
        util.inherits(range, widget), range.prototype.init = function() {
          ...
          if ("edge" == this.mode) this.hslider ? "start" == this.firsttouch ? (this.val.start = this.clickPos.x / this.GUI.w, this.clickPos.touches.length > 1 && (this.val.stop = this.clickPos.touches[1].x / this.GUI.w)) : (this.val.stop = this.clickPos.x / this.GUI.w, this.clickPos.touches.length > 1 && (this.val.start = this.clickPos.touches[1].x / this.GUI.w)) : "start" == this.firsttouch ? (this.val.start = math.invert(this.clickPos.y / this.GUI.h), this.clickPos.touches.length > 1 && (this.val.stop = math.invert(this.clickPos.touches[1].y / this.GUI.h))) : (this.val.stop = math.invert(this.clickPos.y / this.GUI.h), this.clickPos.touches.length > 1 && (this.val.start = math.invert(this.clickPos.touches[1].y / this.GUI.h))), this.val.stop < this.val.start && (this.tempstart = this.val.start, this.val.start = this.val.stop, this.val.stop = this.tempstart, "start" == this.firsttouch ? this.firsttouch = "stop" : this.firsttouch = "start"), this.val = {
            ...
            if (this.hslider) var t = this.clickPos.x / this.GUI.w,
              e = (this.touchdown.y - this.clickPos.y) / this.GUI.h;
            else {
              var t = nx.invert(this.clickPos.y / this.GUI.h),
                e = (this.touchdown.x - this.clickPos.x) / this.GUI.w;
              e *= -1
            }
            e /= 3;
            var i = this.startval.size + e;
            i = math.clip(i, .001, 1), this.val = {
              start: t - i / 2,
              stop: t + i / 2
      ...
      30: [function(t, e, i) {
        var g = t("util"),
          ...
          I = e.exports = function(t) {
            this.defaultSize = {
              width: 200,
              height: 30
            }, s.call(this, t), this.choices = [], this.val = new Object, this.canvas.ontouchstart = null, this.canvas.ontouchmove = null, this.canvas.ontouchend = null, this.canvas.getAttribute("choices") && (this.choices = this.canvas.getAttribute("choices"), this.choices = this.choices.split(","));
            var e = '<select id="' + this.canvasID + '" class="nx" nx="select" style="height:' + this.GUI.h + "px;width:" + this.GUI.w + 'px;" onchange="' + this.canvasID + '.change(this)"></select><canvas height="1px" width="1px" style="display:none"></canvas>',
              i = this.canvas,
              g = this.canvas.style,
              I = i.parentNode,
              A = document.createElement("span");
            A.innerHTML = e, A.className = "nx", I.replaceChild(A, i), this.sel = document.getElementById(this.canvasID);
            for (var n in g) this.sel.style[n] = g[n];
        ...
        g.inherits(I, s), I.prototype.init = function() {
          ...
          for (e = 0; e < t; e++) this.canvas.options[e] = null;
          for (var e = 0; e < this.choices.length; e++) {
            var i = document.createElement("option");
            i.text = this.choices[e], i.value = this.choices[e], this.canvas.add(i, null)
          }
          this.val.text = this.choices[0]
        }, I.prototype.change = function(t) {
          this.val.text = t.value, this.val.value = t.selectedIndex, this.transmit(this.val)
        }, I.prototype.draw = function() {
      ...
      32: [function(require, module, exports) {
        ...
        util.inherits(string, widget), string.prototype.init = function() {
          ...
          this.val = {
            string: e,
            x: this.clickPos.x / this.GUI.w
          }, this.transmit(this.val), this.strings[e].held = !1, this.strings[e].force = this.clickPos.y - this.strings[e].y1, this.strings[e].maxstretch = Math.abs(this.clickPos.y - this.strings[e].y1), this.strings[e].stretch = this.clickPos.y - this.strings[e].y1, this.strings[e].vibrating = !0, this.strings[e].direction = (this.clickPos.y - this.strings[e].y1) / Math.abs(this.clickPos.y - this.strings[e].y1) * ((this.clickPos.y - this.strings[e].y1) / -1.2)
      ...
      34: [function(t, e, i) {
        var g = t("util"),
          ...
          I = e.exports = function(t) {
            this.defaultSize = {
              width: 200,
              height: 100
            }, s.call(this, t), this.val = {
              text: ""
            };
            var e = '<textarea id="' + this.canvasID + '" style="height:' + this.GUI.h + "px;width:" + this.GUI.w + 'px;" onkeydown="' + this.canvasID + '.change(event,this)"></textarea><canvas height="1px" width="1px" style="display:none"></canvas>',
              i = this.canvas,
              g = this.canvas.style,
              I = i.parentNode,
              A = document.createElement("span");
            A.innerHTML = e, A.className = "nx", I.replaceChild(A, i), this.el = document.getElementById(this.canvasID);
            for (var n in g) this.el.style[n] = g[n];
        ...
        g.inherits(I, s), I.prototype.init = function() {
          ...
          this.val.text = e.value, "13" == t.which && (this.transmit(this.val), this.val.text = "", this.draw(), t.preventDefault())
        }, I.prototype.draw = function() {
      ...
      37: [function(require, module, exports) {
        ...
        util.inherits(typewriter, widget), typewriter.prototype.init = function() {
          ...
          if (this.active) {
            for (var e = t.which, i = 0; i < this.rows.length; i++)
              for (var g = 0; g < this.rows[i].length; g++)
                if (e == this.rows[i][g].value) {
                  this.val.key = this.rows[i][g].symbol, this.val.on = 1, this.val.ascii = t.which, this.transmit(this.val);
                  break
                } this.draw()
          }
          ...
          if (this.active) {
            for (var e = t.which, i = 0; i < this.rows.length; i++)
              for (var g = 0; g < this.rows[i].length; g++)
                if (e == this.rows[i][g].value) {
                  this.val.key = this.rows[i][g].symbol, this.val.on = 0, this.val.ascii = t.which, this.transmit(this.val);
                  break
                } this.draw()
          }
      ...
      39: [function(require, module, exports) {
        ...
        util.inherits(waveform, widget), waveform.prototype.init = function() {
          ...
          for (var e = 0; e < this.channels; e++) {
            ...
            for (var i = 1 + ~~(this.rawbuffer[0].length / (5 * this.sampleRate)), g = ~~(this.rawbuffer[e].length / this.pieces), s = 0, I = 0, A = 0, n = 0; n < this.rawbuffer[e].length; n += i) this.rawbuffer[e][n] > 0 ? s = Math.max(s, this.rawbuffer[e][n]) : I = Math.min(I, this.rawbuffer[e][n]), n > A * g && (this.buffer[e].push([s, I]), A++, I = 0, s = 0)
          }
        ...
        }, waveform.prototype.select = function(t, e) {
          this.val.start = math.clip(t / this.durationMS, 0, 1), this.val.stop = math.clip(e / this.durationMS, 0, 1), this.val.size = this.val.stop - this.val.start, this.val.starttime = t, this.val.stoptime = e, this.val.looptime = t - e, this.transmit(this.val), this.draw()
          ...
          with(this.context) {
            ...
            var x1 = this.val.start * this.GUI.w,
              ...
              x2 = this.val.stop * this.GUI.w,
              y2 = this.GUI.h;
            if (fillStyle = this.colors.accent, strokeStyle = this.colors.accent, lineWidth = 2, globalAlpha = .3, fillRect(x1, 0, x2 - x1, y2 - 0), globalAlpha = .7, strokeRect(x1, -2, x2 - x1, y2 - 0 + 4), this.durationMS && this.val.looptime) {
        ...
        }, waveform.prototype.msToTime = function(t, e) {
          var e = e || 2,
            i = ~~(t / 1e3),
            g = i % 60;
          i = (i - g) / 60;
          var s = i % 60,
            I = t % 1e3;
          return g = g < 10 && s ? g + "0" : g, 1 == e ? g + "." + I : 2 == e ? s + ":" + g + "." + I : 3 == e ? s + ":" + g : void 0
      ...
      40: [function(t, e, i) {
        ...
        e.exports = g, g.EventEmitter = g, g.prototype._events = void 0, g.prototype._maxListeners = void 0, g.defaultMaxListeners = 10, g.prototype.setMaxListeners = function(t) {
          ...
          if (i = this._events[t], n(i)) return !1;
          if (s(i)) switch (arguments.length) {
            ...
            case 3:
              ...
              break;
            default:
              for (g = arguments.length, I = new Array(g - 1), C = 1; C < g; C++) I[C - 1] = arguments[C];
              i.apply(this, I)
          } else if (A(i)) {
            for (g = arguments.length, I = new Array(g - 1), C = 1; C < g; C++) I[C - 1] = arguments[C];
            for (o = i.slice(), g = o.length, C = 0; C < g; C++) o[C].apply(this, I)
          } return !0
        }, g.prototype.addListener = function(t, e) {
          var i;
          if (!s(e)) throw TypeError("listener must be a function");
          if (this._events || (this._events = {}), this._events.newListener && this.emit("newListener", t, s(e.listener) ? e.listener : e), this._events[t] ? A(this._events[t]) ? this._events[t].push(e) : this._events[t] = [this._events[t], e] : this._events[t] = e, A(this._events[t]) && !this._events[t].warned) {
            var i;
            i = n(this._maxListeners) ? g.defaultMaxListeners : this._maxListeners, i && i > 0 && this._events[t].length > i && (this._events[t].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[t].length), "function" == typeof console.trace && console.trace())
          }
          return this
        }, g.prototype.on = g.prototype.addListener, g.prototype.once = function(t, e) {
          function i() {
            this.removeListener(t, i), g || (g = !0, e.apply(this, arguments))
          }
          if (!s(e)) throw TypeError("listener must be a function");
          var g = !1;
          ...
          if (i = this._events[t], I = i.length, g = -1, i === e || s(i.listener) && i.listener === e) delete this._events[t], this._events.removeListener && this.emit("removeListener", t, e);
          else if (A(i)) {
            for (n = I; n-- > 0;)
              if (i[n] === e || i[n].listener && i[n].listener === e) {
                g = n;
                break
              } if (g < 0) return this;
            1 === i.length ? (i.length = 0, delete this._events[t]) : i.splice(g, 1), this._events.removeListener && this.emit("removeListener", t, e)
          }
          return this
      ...
      42: [function(t, e, i) {
        ...
        }(), s.title = "browser", s.browser = !0, s.env = {}, s.argv = [], s.on = g, s.addListener = g, s.once = g, s.off = g, s.removeListener = g, s.removeAllListeners = g, s.emit = g, s.binding = function(t) {
      ...
      44: [function(t, e, i) {
        (function(e, g) {
          function s(t, e) {
            ...
            return arguments.length >= 3 && (g.depth = arguments[2]), arguments.length >= 4 && (g.colors = arguments[3]), d(e) ? g.showHidden = e : e && i._extend(g, e), y(g.showHidden) && (g.showHidden = !1), y(g.depth) && (g.depth = 2), y(g.colors) && (g.colors = !1), y(g.customInspect) && (g.customInspect = !0), g.colors && (g.stylize = I), C(g, t, g.depth)
          }
          ...
          function C(t, e, g) {
            if (t.customInspect && e && S(e.inspect) && e.inspect !== i.inspect && (!e.constructor || e.constructor.prototype !== e)) {
              var s = e.inspect(g, t);
              return m(s) || (s = C(t, s, g)), s
            }
            var I = o(t, e);
            if (I) return I;
            var A = Object.keys(e),
              d = n(A);
            if (t.showHidden && (A = Object.getOwnPropertyNames(e)), k(e) && (A.indexOf("message") >= 0 || A.indexOf("description") >= 0)) return r(e);
            if (0 === A.length) {
              if (S(e)) {
                var u = e.name ? ": " + e.name : "";
            ...
            var p = "",
              ...
              v = ["{", "}"];
            if (c(e) && (f = !0, v = ["[", "]"]), S(e)) {
              p = " [Function" + (e.name ? ": " + e.name : "") + "]"
            }
            if (w(e) && (p = " " + RegExp.prototype.toString.call(e)), x(e) && (p = " " + Date.prototype.toUTCString.call(e)), k(e) && (p = " " + r(e)), 0 === A.length && (!f || 0 == e.length)) return v[0] + p + v[1];
            if (g < 0) return w(e) ? t.stylize(RegExp.prototype.toString.call(e), "regexp") : t.stylize("[Object]", "special");
            t.seen.push(e);
            var y;
            return y = f ? a(t, e, g, d, A) : A.map(function(i) {
              return h(t, e, g, d, i, f)
            }), t.seen.pop(), l(y, p, v)
          }
          ...
          function o(t, e) {
            ...
            return f(e) ? t.stylize("" + e, "number") : d(e) ? t.stylize("" + e, "boolean") : u(e) ? t.stylize("null", "null") : void 0
          }
          ...
          function a(t, e, i, g, s) {
            for (var I = [], A = 0, n = e.length; A < n; ++A) M(e, String(A)) ? I.push(h(t, e, i, g, String(A), !0)) : I.push("");
            return s.forEach(function(s) {
              s.match(/^\d+$/) || I.push(h(t, e, i, g, s, !0))
            }), I
          }

          function h(t, e, i, g, s, I) {
            var A, n, o;
            if (o = Object.getOwnPropertyDescriptor(e, s) || {
                value: e[s]
              }, o.get ? n = o.set ? t.stylize("[Getter/Setter]", "special") : t.stylize("[Getter]", "special") : o.set && (n = t.stylize("[Setter]", "special")), M(g, s) || (A = "[" + s + "]"), n || (t.seen.indexOf(o.value) < 0 ? (n = u(i) ? C(t, o.value, null) : C(t, o.value, i - 1), n.indexOf("\n") > -1 && (n = I ? n.split("\n").map(function(t) {
                return "  " + t
              }).join("\n").substr(2) : "\n" + n.split("\n").map(function(t) {
                return "   " + t
              }).join("\n"))) : n = t.stylize("[Circular]", "special")), y(A)) {
              if (I && s.match(/^\d+$/)) return n;
          ...
          function l(t, e, i) {
            ...
            return t.reduce(function(t, e) {
              return g++, e.indexOf("\n") >= 0 && g++, t + e.replace(/\u001b\[\d\d?m/g, "").length + 1
          ...
          function x(t) {
            return b(t) && "[object Date]" === G(t)
          }

          function k(t) {
            return b(t) && ("[object Error]" === G(t) || t instanceof Error)
          }
          ...
          i.format = function(t) {
            ...
            for (var i = 1, g = arguments, I = g.length, A = String(t).replace(/%[sdj%]/g, function(t) {
                if ("%%" === t) return "%";
                if (i >= I) return t;
                switch (t) {
                  case "%s":
              ...
              }), n = g[i]; i < I; n = g[++i]) u(n) || !b(n) ? A += " " + n : A += " " + s(n);
            return A
          }, i.deprecate = function(t, s) {
            function I() {
              if (!A) {
                if (e.throwDeprecation) throw new Error(s);
                e.traceDeprecation ? console.trace(s) : console.error(s), A = !0
              }
              return t.apply(this, arguments)
            }
            if (y(g.process)) return function() {
          ...
          i.debuglog = function(t) {
            if (y(E) && (E = e.env.NODE_DEBUG || ""), t = t.toUpperCase(), !z[t])
              if (new RegExp("\\b" + t + "\\b", "i").test(E)) {
                var g = e.pid;
                z[t] = function() {
                  var e = i.format.apply(i, arguments);
                  console.error("%s %d: %s", t, g, e)
                }
              } else z[t] = function() {};
            return z[t]
            ...
            date: "magenta",
            regexp: "red"
          }, i.isArray = c, i.isBoolean = d, i.isNull = u, i.isNullOrUndefined = p, i.isNumber = f, i.isString = m, i.isSymbol = v, i.isUndefined = y, i.isRegExp = w, i.isObject = b, i.isDate = x, i.isError = k, i.isFunction = S, i.isPrimitive = T, i.isBuffer = t("./support/isBuffer");
          ...
          i.log = function() {
            ...
            if (!e || !b(e)) return t;
            for (var i = Object.keys(e), g = i.length; g--;) t[i[g]] = e[i[g]];
            return t
          }
        }).call(this, t("_process"), void 0 !== global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
      }, {
        "./support/isBuffer": 43,
        _process: 42,
        inherits: 41
      ...
      45: [function(t, e, i) {
        var g = Object.prototype.hasOwnProperty,
          ...
          I = function(t) {
            ...
            var e = g.call(t, "constructor"),
              i = t.constructor && t.constructor.prototype && g.call(t.constructor.prototype, "isPrototypeOf");
            if (t.constructor && !e && !i) return !1;
            var I;
            for (I in t);
            return void 0 === I || g.call(t, I)
          };
        e.exports = function t() {
          "use strict";
          var e, i, g, s, A, n, C = arguments[0],
            o = 1,
            r = arguments.length,
            a = !1;
          for ("boolean" == typeof C ? (a = C, C = arguments[1] || {}, o = 2) : ("object" != typeof C && "function" != typeof C || null == C) && (C = {}); o < r; ++o)
            if (null != (e = arguments[o]))
              for (i in e) g = C[i], s = e[i], C !== s && (a && s && (I(s) || (A = Array.isArray(s))) ? (A ? (A = !1, n = g && Array.isArray(g) ? g : []) : n = g && I(g) ? g : {}, C[i] = t(a, n, s)) : void 0 !== s && (C[i] = s));
          return C
        }
      }, {}],
      46: [function(t, e, i) {
        ! function() {
          ...
          function g(t, e, i) {
            ...
            if (2 < arguments.length) {
              ...
              return function() {
                ...
                return Array.prototype.unshift.apply(i, g), t.apply(e, i)
              }
            }
            return function() {
          ...
          function s(e, i, I) {
            return s = Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? t : g, s.apply(null, arguments)
          }
          ...
          function A(t, e, i) {
            t = t.H.getElementsByTagName(e)[0], t || (t = document.documentElement), t.insertBefore(i, t.lastChild)
          }

          function n(t, e, i) {
            e = e || [], i = i || [];
            for (var g = t.className.split(/\s+/), s = 0; s < e.length; s += 1) {
              for (var I = !1, A = 0; A < g.length; A += 1)
                if (e[s] === g[A]) {
                  I = !0;
                  break
                } I || g.push(e[s])
            }
            for (e = [], s = 0; s < g.length; s += 1) {
              for (I = !1, A = 0; A < i.length; A += 1)
                if (g[s] === i[A]) {
                  I = !0;
                  break
                } I || e.push(g[s])
          ...
          function C(t, e) {
            for (var i = t.className.split(/\s+/), g = 0, s = i.length; g < s; g++)
              if (i[g] == e) return !0;
            return !1
          }
          ...
          function r(t, e, i) {
            ...
            $ ? (e.onload = function() {
              ...
              s = !0, n = Error("Stylesheet failed to load"), g()
            }) : setTimeout(function() {
              s = !0, g()
            }, 0), A(t, "head", e)
          }
          ...
          function a(t, e, i, g) {
            var s = t.H.getElementsByTagName("head")[0];
            if (s) {
              ...
              return I.onload = I.onreadystatechange = function() {
                A || this.readyState && "loaded" != this.readyState && "complete" != this.readyState || (A = !0, i && i(null), I.onload = I.onreadystatechange = null, "HEAD" == I.parentNode.tagName && s.removeChild(I))
          ...
          function p(t, e) {
            ...
            i && (this.L = i[1], this.M = parseInt(i[2], 10))
          }
          ...
          function m(t) {
            ...
            for (var i = 0; i < t.length; i++) {
              var g = t[i].replace(/['"]/g, ""); - 1 != g.indexOf(" ") || /^\d/.test(g) ? e.push("'" + g + "'") : e.push(g)
            }
            return e.join(",")
          }
          ...
          function w(t) {
            var e = 4,
              i = "n",
              g = null;
            return t && ((g = t.match(/(normal|oblique|italic)/i)) && g[1] && (i = g[1].substr(0, 1).toLowerCase()), (g = t.match(/([1-9]00|normal|bold)/i)) && g[1] && (/bold/i.test(g[1]) ? e = 7 : /[1-9]00/.test(g[1]) && (e = parseInt(g[1].substr(0, 1), 10)))), i + e
          }

          function b(t, e) {
            this.a = t, this.j = t.k.document.documentElement, this.O = e, this.g = "wf", this.e = new u("-"), this.da = !1 !== e.events, this.u = !1 !== e.classes
          }
          ...
          function k(t) {
            if (t.u) {
              var e = C(t.j, t.e.d(t.g, "active")),
                i = [],
                g = [t.e.d(t.g, "loading")];
              e || i.push(t.e.d(t.g, "inactive")), n(t.j, i, g)
            }
            S(t, "inactive")
          }

          function S(t, e, i) {
            t.da && t.O[e] && (i ? t.O[e](i.getName(), v(i)) : t.O[e]())
          }
          ...
          function P(t, e) {
            var i, g = t.m;
            i = "display:block;position:absolute;top:-9999px;left:-9999px;font-size:300px;width:auto;height:auto;line-height:normal;margin:0;padding:0;font-variant:normal;white-space:nowrap;font-family:" + m(e.Q) + ";font-style:" + y(e) + ";font-weight:" + e.M + "00;", g.style.cssText = i
          }
          ...
          function E(t, e, i, g, s, I) {
            this.G = t, this.J = e, this.f = g, this.a = i, this.v = s || 3e3, this.h = I || void 0
          }

          function z(t, e, i, g, s, I, A) {
            this.G = t, this.J = e, this.a = i, this.f = g, this.h = A || "BESbswy", this.s = {}, this.v = s || 3e3, this.Z = I || null, this.D = this.C = this.A = this.w = null, this.w = new U(this.a, this.h), this.A = new U(this.a, this.h), this.C = new U(this.a, this.h), this.D = new U(this.a, this.h), P(this.w, new p(this.f.getName() + ",serif", v(this.f))), P(this.A, new p(this.f.getName() + ",sans-serif", v(this.f))), P(this.C, new p("serif", v(this.f))), P(this.D, new p("sans-serif", v(this.f))), M(this.w), M(this.A), M(this.C), M(this.D)
          }
          ...
          function j(t, e, i) {
            for (var g in tt)
              if (tt.hasOwnProperty(g) && e === t.s[tt[g]] && i === t.s[tt[g]]) return !0;
            return !1
          }

          function N(t) {
            var e, i = t.w.m.offsetWidth,
              g = t.A.m.offsetWidth;
            (e = i === t.s.serif && g === t.s["sans-serif"]) || (e = L() && j(t, i, g)), e ? J() - t.ga >= t.v ? L() && j(t, i, g) && (null === t.Z || t.Z.hasOwnProperty(t.f.getName())) ? D(t, t.G) : D(t, t.J) : R(t) : D(t, t.G)
          }
          ...
          function D(t, e) {
            setTimeout(s(function() {
              this.w.remove(), this.A.remove(), this.C.remove(), this.D.remove(), e(this.f)
            }, t), 0)
          }

          function _(t, e, i) {
            this.a = t, this.p = e, this.P = 0, this.ba = this.Y = !1, this.v = i
          }

          function W(t) {
            0 == --t.P && t.Y && (t.ba ? (t = t.p, t.u && n(t.j, [t.e.d(t.g, "active")], [t.e.d(t.g, "loading"), t.e.d(t.g, "inactive")]), S(t, "active")) : k(t.p))
          }

          function O(t) {
            this.F = t, this.q = new T, this.$ = 0, this.T = this.U = !0
          }

          function B(t, e, i, g, I) {
            var A = 0 == --t.$;
            (t.T || t.U) && setTimeout(function() {
              var t = I || null,
                C = g || null || {};
              if (0 === i.length && A) k(e.p);
              else {
                ...
                for (o = 0; o < i.length; o++) {
                  var a = i[o],
                    ...
                    l = e.p,
                    c = a;
                  l.u && n(l.j, [l.e.d(l.g, c.getName(), v(c).toString(), "loading")]), S(l, "fontloading", c), l = null, l = it ? new E(s(e.V, e), s(e.W, e), e.a, a, e.v, h) : new z(s(e.V, e), s(e.W, e), e.a, a, e.v, t, h), r.push(l)
                }
                for (o = 0; o < r.length; o++) r[o].start()
              }
            }, 0)
          }
          ...
          function q(t, e, i) {
            ...
            var g = G(t.q, i, t.a),
              I = new _(t.a, e, s);
            for (t.$ = g.length, e = 0, i = g.length; e < i; e++) g[e].load(function(e, i, g) {
              B(t, I, e, i, g)
            })
          }

          function F(t, e, i) {
            this.N = t || e + gt, this.o = [], this.R = [], this.ca = i || ""
          }

          function Z(t, e) {
            for (var i = e.length, g = 0; g < i; g++) {
              var s = e[g].split(":");
              3 == s.length && t.R.push(s.pop());
              var I = "";
              2 == s.length && "" != s[1] && (I = ":"), t.o.push(s.join(I))
            }
          }
          ...
          var J = Date.now || function() {
            ...
            $ = !!window.FontFace;
          I.prototype.createElement = function(t, e, i) {
            if (t = this.H.createElement(t), e)
              for (var g in e) e.hasOwnProperty(g) && ("style" == g ? t.style.cssText = e[g] : t.setAttribute(g, e[g]));
            return i && t.appendChild(this.H.createTextNode(i)), t
            ...
            var t = this.a.k.document,
              e = this;
            Promise.race([new Promise(function(t, i) {
              setTimeout(function() {
                i(e.f)
              }, e.v)
            }), t.fonts.load(f(this.f), this.h)]).then(function(t) {
              1 === t.length ? e.G(e.f) : e.J(e.f)
            }, function() {
              e.J(e.f)
            })
          };
          ...
          z.prototype.start = function() {
            this.s.serif = this.C.m.offsetWidth, this.s["sans-serif"] = this.D.m.offsetWidth, this.ga = J(), N(this)
          };
          var it = !!window.FontFace;
          _.prototype.V = function(t) {
            var e = this.p;
            e.u && n(e.j, [e.e.d(e.g, t.getName(), v(t).toString(), "active")], [e.e.d(e.g, t.getName(), v(t).toString(), "loading"), e.e.d(e.g, t.getName(), v(t).toString(), "inactive")]), S(e, "fontactive", t), this.ba = !0, W(this)
          }, _.prototype.W = function(t) {
            var e = this.p;
            if (e.u) {
              var i = C(e.j, e.e.d(e.g, t.getName(), v(t).toString(), "active")),
                g = [],
                s = [e.e.d(e.g, t.getName(), v(t).toString(), "loading")];
              i || g.push(e.e.d(e.g, t.getName(), v(t).toString(), "inactive")), n(e.j, g, s)
            }
            S(e, "fontinactive", t), W(this)
          }, O.prototype.load = function(t) {
            this.a = new I(this.F, t.context || this.F), this.U = !1 !== t.events, this.T = !1 !== t.classes, q(this, new b(this.a, t), t)
          };
          ...
          F.prototype.d = function() {
            ...
            for (var t = this.o.length, e = [], i = 0; i < t; i++) e.push(this.o[i].replace(/ /g, "+"));
          ...
          Y.prototype.parse = function() {
            for (var t = this.o.length, e = 0; e < t; e++) {
              var i = this.o[e].split(":"),
                g = i[0].replace(/\+/g, " "),
                s = ["n4"];
              if (2 <= i.length) {
                var I, A = i[1];
                if (I = [], A)
                  for (var A = A.split(","), n = A.length, C = 0; C < n; C++) {
                    var o;
                    if (o = A[C], o.match(/^[\w-]+$/))
                      if (null == (o = nt.exec(o.toLowerCase()))) o = "";
                      else {
                        var r;
                        if (null == (r = o[1]) || "" == r) r = "4";
                        else {
                          var a = It[r];
                          r = a || (isNaN(r) ? "4" : r.substr(0, 1))
                        }
                        o = o[2], o = [null == o || "" == o ? "n" : At[o], r].join("")
                      }
                    else o = "";
                    o && I.push(o)
                  }
                0 < I.length && (s = I), 3 == i.length && (i = i[2], I = [], i = i ? i.split(",") : I, 0 < i.length && (i = st[i[0]]) && (this.I[g] = i))
              }
              for (this.I[g] || (i = st[g]) && (this.I[g] = i), i = 0; i < s.length; i += 1) this.aa.push(new p(g, s[i]))
            }
          };
          var Ct = {
            Arimo: !0,
          ...
          V.prototype.load = function(t) {
            var e = new h,
              i = this.a,
              g = new F(this.c.api, o(i), this.c.text),
              s = this.c.families;
            Z(g, s);
            var I = new Y(s);
            I.parse(), r(i, g.d(), l(e)), c(e, function() {
              t(I.aa, I.I, Ct)
            })
          }, H.prototype.B = function(t) {
            var e = this.a;
            return o(this.a) + (this.c.api || "//f.fontdeck.com/s/css/js/") + (e.k.location.hostname || e.F.location.hostname) + "/" + t + ".js"
            ...
            e ? (i.__webfontfontdeckmodule__ || (i.__webfontfontdeckmodule__ = {}), i.__webfontfontdeckmodule__[e] = function(e, i) {
              for (var s = 0, I = i.fonts.length; s < I; ++s) {
                var A = i.fonts[s];
                g.X.push(new p(A.name, w("font-weight:" + A.weight + ";font-style:" + A.style)))
              }
              t(g.X)
            }, a(this.a, this.B(e), function(e) {
              e && t([])
            })) : t([])
          }, X.prototype.B = function(t) {
            return (this.c.api || "https://use.typekit.net") + "/" + t + ".js"
          }, X.prototype.load = function(t) {
            var e = this.c.id,
              i = this.a.k;
            e ? a(this.a, this.B(e), function(e) {
              if (e) t([]);
              else if (i.Typekit && i.Typekit.config && i.Typekit.config.fn) {
                e = i.Typekit.config.fn;
                for (var g = [], s = 0; s < e.length; s += 2)
                  for (var I = e[s], A = e[s + 1], n = 0; n < A.length; n++) g.push(new p(I, A[n]));
                try {
                  i.Typekit.load({
                    events: !1,
                    classes: !1,
          ...
          }, K.prototype.B = function(t, e) {
            return o(this.a) + "//" + (this.c.api || "fast.fonts.net/jsapi").replace(/^.*http(s?):(\/\/)?/, "") + "/" + t + ".js" + (e ? "?v=" + e : "")
          }, K.prototype.load = function(t) {
            function e() {
              if (s["__mti_fntLst" + i]) {
                var g, I = s["__mti_fntLst" + i](),
                  A = [];
                if (I)
                  for (var n = 0; n < I.length; n++) {
                    var C = I[n].fontfamily;
                    void 0 != I[n].fontStyle && void 0 != I[n].fontWeight ? (g = I[n].fontStyle + I[n].fontWeight, A.push(new p(C, g))) : A.push(new p(C))
                  }
                t(A)
            ...
            var i = this.c.projectId,
              g = this.c.version;
            if (i) {
              var s = this.a.k;
              a(this.a, this.B(i, g), function(i) {
                i ? t([]) : e()
              }).id = "__MonotypeAPIScript__" + i
            } else t([])
          }, Q.prototype.load = function(t) {
            var e, i, g = this.c.urls || [],
              s = this.c.families || [],
              I = this.c.testStrings || {},
              A = new h;
            for (e = 0, i = g.length; e < i; e++) r(this.a, g[e], l(A));
            var n = [];
            for (e = 0, i = s.length; e < i; e++)
              if (g = s[e].split(":"), g[1])
                for (var C = g[1].split(","), o = 0; o < C.length; o += 1) n.push(new p(g[0], C[o]));
              else n.push(new p(g[0]));
            c(A, function() {
              t(n, I)
            })
          };
          var ot = new O(window);
          ot.q.t.custom = function(t, e) {
            return new Q(e, t)
          }, ot.q.t.fontdeck = function(t, e) {
            return new H(e, t)
          }, ot.q.t.monotype = function(t, e) {
            return new K(e, t)
          }, ot.q.t.typekit = function(t, e) {
            return new X(e, t)
          }, ot.q.t.google = function(t, e) {
            return new V(e, t)
          };
          var rt = {
            load: s(ot.load, ot)
  ...
  t.exports = function(t) {
    ...
    return e.toString = function() {
      ...
      for (var g = {}, s = 0; s < this.length; s++) {
        var I = this[s][0];
        "number" == typeof I && (g[I] = !0)
      }
      for (s = 0; s < t.length; s++) {
        var A = t[s];
        "number" == typeof A[0] && g[A[0]] || (i && !A[2] ? A[2] = i : i && (A[2] = "(" + A[2] + ") and (" + i + ")"), e.push(A))
      }
    }, e
  }
}, function(t, e) {
  ...
  function g(t, e) {
    for (var i = 0; i < t.length; i++) {
      ...
      if (s) {
        s.refs++;
        for (var I = 0; I < s.parts.length; I++) s.parts[I](g.parts[I]);
        for (; I < g.parts.length; I++) s.parts.push(r(g.parts[I], e))
      } else {
        for (var A = [], I = 0; I < g.parts.length; I++) A.push(r(g.parts[I], e));
        c[g.id] = {
          id: g.id,
          refs: 1,
          parts: A
  ...
  function s(t, e) {
    for (var i = [], g = {}, s = 0; s < t.length; s++) {
      ...
      g[A] ? g[A].parts.push(r) : i.push(g[A] = {
        id: A,
        parts: [r]
      })
    }
  ...
  function I(t, e) {
    var i = u(t.insertInto);
    if (!i) throw new Error("Couldn't find a style target. This probably means that the value for the 'insertInto' parameter is invalid.");
    var g = m[m.length - 1];
    if ("top" === t.insertAt) g ? g.nextSibling ? i.insertBefore(e, g.nextSibling) : i.appendChild(e) : i.insertBefore(e, i.firstChild), m.push(e);
    else {
  ...
  function n(t) {
    ...
    return t.attrs.type = "text/css", o(e, t.attrs), I(t, e), e
  }

  function C(t) {
    var e = document.createElement("link");
    return t.attrs.type = "text/css", t.attrs.rel = "stylesheet", o(e, t.attrs), I(t, e), e
  }
  ...
  function r(t, e) {
    ...
    if (e.singleton) {
      var o = f++;
      i = p || (p = n(e)), g = a.bind(null, i, o, !1), s = a.bind(null, i, o, !0)
    } else t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (i = C(e), g = l.bind(null, i, e), s = function() {
      A(i), i.href && URL.revokeObjectURL(i.href)
    }) : (i = n(e), g = h.bind(null, i), s = function() {
      A(i)
    });
    return g(t),
      function(e) {
  ...
  function h(t, e) {
    var i = e.css,
      g = e.media;
    if (g && t.setAttribute("media", g), t.styleSheet) t.styleSheet.cssText = i;
    else {
  ...
  t.exports = function(t, e) {
    ...
    e = e || {}, e.attrs = "object" == typeof e.attrs ? e.attrs : {}, void 0 === e.singleton && (e.singleton = d()), void 0 === e.insertInto && (e.insertInto = "head"), void 0 === e.insertAt && (e.insertAt = "bottom");
    var i = s(t, e);
    return g(i, e),
      function(t) {
        for (var I = [], A = 0; A < i.length; A++) {
          var n = i[A],
            C = c[n.id];
          C.refs--, I.push(C)
        }
        ...
        for (var A = 0; A < I.length; A++) {
          var C = I[A];
          if (0 === C.refs) {
            for (var o = 0; o < C.parts.length; o++) C.parts[o]();
            delete c[C.id]
          }
        }
      }
  ...
  t.exports = function(t) {
    ...
    return t.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(t, e) {
      ...
      var I;
      return I = 0 === s.indexOf("//") ? s : 0 === s.indexOf("/") ? i + s : g + s.replace(/^\.\//, ""), "url(" + JSON.stringify(I) + ")"
    })
  }
}, function(t, e, i) {
  var g = i(24);
