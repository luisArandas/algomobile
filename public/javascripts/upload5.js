if ($(window).width() < 960) {
  ...
  document.getElementById('regist').style["color"] = "white";
    ...
    document.getElementById('register').style["top"] = "130%";
    document.getElementById('register').style["color"] = "white";
    document.getElementById('register').style["font-family"] = "Proxima Nova !important";

    document.getElementById('register').style["left"] = "1%";
    document.getElementById('register').style["height"] = "80%";
    document.getElementById('register').style["width"] = "98%";
